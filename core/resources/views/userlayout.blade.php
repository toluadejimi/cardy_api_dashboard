        ...
        <div class="scrollbar-inner">
            ...
            <div class="navbar-inner">
                ...
                <div class="collapse navbar-collapse" id="sidenav-collapse-main">
                    ...
                    <ul class="navbar-nav mb-3">
                        ...
                        @if($set->vcard==1)
                        @if($currency->name=='NGN' || $currency->name=='USD' || $currency->name=='GNF' ||
                        $currency->name=='KES' || $currency->name=='LRD' || $currency->name=='MWK' ||
                        $currency->name=='MZN' || $currency->name=='RWF' || $currency->name=='SLL' ||
                        $currency->name=='BIF' || $currency->name=='CAD' || $currency->name=='CDF' ||
                        $currency->name=='CVE' || $currency->name=='EUR' || $currency->name=='GBP' ||
                        $currency->name=='GHS' || $currency->name=='GMD' || $currency->name=='STD' ||
                        $currency->name=='TZS' || $currency->name=='TZS' || $currency->name=='UGX' ||
                        $currency->name=='XAF' || $currency->name=='XOF' || $currency->name=='ZMK' ||
                        $currency->name=='ZMW' || $currency->name=='ZWD')
                        <li class="nav-item">
                            <a class="nav-link @if(route('user.virtualcard')==url()->current()) active @endif"
                                href="{{route('user.virtualcard')}}">
                        ...
                        <li class="nav-item">
                            <a class="nav-link @if(route('user.airtime')==url()->current() || route('user.data.bundle')==url()->current() || route('user.tv.cable')==url()->current() || route('user.electricity')==url()->current()) active @endif"
                            ...
                            <div class="collapse @if(route('user.airtime')==url()->current() || route('user.data.bundle')==url()->current() || route('user.tv.cable')==url()->current() || route('user.electricity')==url()->current()) show @endif"
                                ...
                                <ul class="nav nav-sm flex-column">
                                    <li
                                        class="nav-item @if(route('user.airtime')==url()->current()) active @endif text-default">
                                        <a href="{{route('user.airtime')}}" class="nav-link">{{__('Airtime')}}</a>
                                    </li>
                                    <li
                                        class="nav-item @if(route('user.data.bundle')==url()->current()) active @endif text-default">
                                        <a href="{{route('user.data.bundle')}}" class="nav-link">{{__('Data
                                            Bundle')}}</a>
                                    </li>
                                    <li
                                        class="nav-item @if(route('user.tv.cable')==url()->current()) active @endif text-default">
                                        <a href="{{route('user.tv.cable')}}" class="nav-link">{{__('Tv Cable')}}</a>
                                    </li>
                                    <li
                                        class="nav-item @if(route('user.electricity')==url()->current()) active @endif text-default">
                                        <a href="{{route('user.electricity')}}"
                                            class="nav-link">{{__('Electricity')}}</a>
                                    </li>
                                </ul>
                            </div>
                        </li>
            ...
            @endif
                    ...
                    <ul class="navbar-nav mb-3">
                        ...
                        @if($set->donation==1)
                        <li class="nav-item">
                            <a class="nav-link @if(route('user.dplinks')==url()->current()) active @endif"
                                href="{{route('user.dplinks')}}">
                        ...
                        <li class="nav-item">
                            <a class="nav-link @if(route('user.plan')==url()->current()) active @endif"
                        ...
                        @if($set->merchant==1)
                        <li class="nav-item">
                            <a class="nav-link @if(route('user.merchant')==url()->current()) active @endif"
                                href="{{route('user.merchant')}}">
        ...
        <nav class="navbar navbar-top navbar-expand navbar-dark border-bottom">
            <div class="container-fluid">
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    ...
                    <form class="navbar-search navbar-search-light form-inline mr-sm-3" action="{{route('search')}}"
                        method="post" id="navbar-search-main">
                        @csrf
                        <div class="form-group mb-0">
                            <div class="input-group input-group-alternative input-group-merge">
                                ...
                                <input class="form-control" placeholder="Transactions, Payment references" name="search"
                                    type="text">
                            </div>
                        </div>
                    ...
                    <ul class="navbar-nav align-items-center ml-auto ml-md-0">
                        <li class="nav-item mr-2">
                            <h6 class="h4 mb-0 text-gray font-weight-bolder"><span class="text-primary"><i
                                        class="fad fa-wallet"></i> {{$currency->name. ' '
                                    .number_format($user->main_wallet)}}</span></h6>
                        </li>
