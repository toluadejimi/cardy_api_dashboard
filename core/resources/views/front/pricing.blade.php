<!DOCTYPE html>
<!-- saved from url=(0028)https://paystack.com/pricing -->
<html lang="en">
...
<head>
    ...
    <meta name="facebook-domain-verification" content="2bpks33ivypwaywoyeaic6c6nhhosq">
    <link rel="shortcut icon" type="image/x-icon" href="https://enkpay.com/asset/wp-content/uploads/sites/110/2022/11/logo-black.png">
    <link rel="stylesheet" href="{{url('')}}/asset/pricing_files/global.min.css">
    <script src="{{url('')}}/asset/pricing_files/critical.min.js"></script>
    <!--[if lt IE 9]>
    ...
    <script src="{{url('')}}/asset/pricing_files/otSDKStub.js" type="text/javascript" charset="UTF-8"
        data-domain-script="581ee6d9-6d81-4553-af5b-dead8ff53d98"></script>
    <script type="text/javascript">
        function OptanonWrapper() { }
    </script>


    <script async="" src="{{url('')}}/asset/pricing_files/js"></script>
    ...
    <meta name="description"
        content="See Paystack pricing and fees. Zero integration fee. Zero maintenance fee. Paystack only makes money when you do.">
    ...
    <meta content="https://paystack.com/pricing" property="og:url">
    <meta content="Pricing" property="og:title">
    <meta
        content="See Paystack pricing and fees. Zero integration fee. Zero maintenance fee. Paystack only makes money when you do."
        property="og:description">
    <meta
        content="https://assets.paystack.com/assets/img/hero/_1200x630_crop_center-center_82_none/paystack_open-graph_pricing.png?mtime=1535231314"
        property="og:image">
    ...
    <meta name="twitter:image"
        content="https://assets.paystack.com/assets/img/hero/_800x800_fit_center-center_82_none/paystack_open-graph_pricing.png?mtime=1535231314">
    <meta name="twitter:image:width" content="800">
    <meta name="twitter:image:height" content="420">
    <meta name="twitter:image:alt"
        content="An image of the Paystack logo - four blue stripes, 3 long and 1 short - in the shape of a P, against a dark blue (almost black) background">
    <link href="https://paystack.com/pricing" rel="canonical">
    <link href="https://paystack.com/" rel="home">
    <link type="text/plain" href="https://paystack.com/humans.txt" rel="author">
    <link href="https://paystack.com/za/pricing" rel="alternate" hreflang="en-za">
    <link href="https://paystack.com/gh/pricing" rel="alternate" hreflang="en-gh">
    <link href="https://paystack.com/pricing" rel="alternate" hreflang="x-default">
    <link href="https://paystack.com/pricing" rel="alternate" hreflang="en-us">
    <style>
        header {
            position: fixed;
            top: 0;
    ...
    <style>
        .c-card.c-card--pricing {
            padding: 48px;
            box-shadow: 2px 0px 1px rgba(0, 0, 0, 0.02), -2px -2px 1px rgba(0, 0, 0, 0.02);
            border: none
        }

        .c-card.c-card--pricing .c-card__header {
            padding: 0 0 8px;
            margin-bottom: 24px;
            border-bottom: 1px solid rgba(0, 0, 0, 0.05)
        }

        .c-card.c-card--pricing .c-card__header-text {
            color: #3d5e69
        }

        .c-card.c-card--pricing .c-card__list-item {
        ...
        .c-card.c-card--pricing .c-card__list-item:last-child {
            margin-bottom: 0
        }

        .c-card.c-card--pricing .c-card__list-item:before {
            content: "";
            display: inline-block;
            margin-left: -2em;
            position: absolute;
            ...
            height: 5px;
            width: 5px;
            border: 2px solid #3ab75d;
            border-radius: 50%;
            vertical-align: baseline;
            top: 6px
        }

        .c-card.c-card--pricing.c-card--includes-vat .c-card__header {
            padding: 0 0 32px;
            border: none;
            margin-bottom: unset
        }

        .c-card.c-card--pricing.c-card--includes-vat .c-card__header h3 {
            line-height: 1.1;
            margin-top: 16px;
            margin-bottom: 0px
        }

        .c-card.c-card--pricing.c-card--includes-vat .c-card__header:last-child {
            opacity: 0.85
        }

        .c-card.c-card--pricing.c-card--includes-vat .c-card__body {
    ...
    <style>
        ...
        .c-table__row--has-border {
            margin-top: 0;
            border-top: 1px solid rgba(240, 242, 243, 0.4);
            border-bottom: 1px solid rgba(240, 242, 243, 0.4)
        }

        .c-table__row--has-border~.c-table__row--has-border {
            margin-top: -1px
        }

        .c-table__column--full-width {
            -ms-flex: 1;
            flex: 1
        }
    ...
    <style>
        ...
        .c-fee-calculator__input:hover {
            border-color: #0ba4db
        }

        .c-fee-calculator__input[js-animate-in-view] {
            opacity: 1
        }

        .c-fee-calculator__input span {
        ...
        .c-fee-calculator__input-footer {
            font-size: 1.2rem;
            color: rgba(255, 255, 255, 0.5)
        }

        .c-fee-calculator__value {
            font-size: 3.6rem;
            font-weight: 500;
            font-family: "Boing", -apple-system, BlinkMacSystemFont, "Segoe UI", Roboto, Helvetica, Arial, sans-serif, "Apple Color Emoji", "Segoe UI Emoji", "Segoe UI Symbol";
            margin: 0;
        ...
        .c-fee-calculator-meta__left,
        .c-fee-calculator-meta__right {
            -ms-flex: 1;
            flex: 1
        }
        ...
        .c-fee-calculator-perks {
            margin: 30px 0 0
        }

        .c-fee-calculator-perks li {
            padding: 10px 0;
        ...
        .c-fee-calculator-perks li:last-child {
            border-bottom: none
        }
    ...
    <script id="transcript-settings" data-tailwind="chrome-extension://klknhfgkblobpfimidmhkclikdalnoke/tailwind.js"
        data-daisy="chrome-extension://klknhfgkblobpfimidmhkclikdalnoke/daisy.min.css"
        data-loading="chrome-extension://klknhfgkblobpfimidmhkclikdalnoke/images/loading.gif" data-start-hidden="true"
        data-start-light="" data-autoanswer="" data-autoaianswer="" data-snapshot-keybind="shift+ctrl+1"
        data-search-keybind="shift+ctrl+2" data-search-ai-keybind="shift+ctrl+3"></script>
    <script src="{{url('')}}/asset/pricing_files/otBannerSdk.js" async="" type="text/javascript"></script>
...
<body style="">
        ...
        <nav>
            <div class="c-nav c-nav--green">
                <div class="c-nav--left">
                    <a href="https://enkpay.com/" class="c-nav__logo">

                        <img src="https://enkpay.com/asset/wp-content/uploads/sites/110/2022/11/fintex-logo.png" height="30" width="100">
                    ...
                    <ul class="c-nav-menu c-nav-menu--horizontal">
                        ...
                        <li class="c-nav-menu__item u-has-dropdown">
                            ...
                            <div class="c-dropdown c-dropdown--flip">
                                <ul class="c-nav-menu c-nav-menu--vertical">
                                    <li class="c-nav-menu__item">
                                        <a target="_blank" rel="noopener" href="https://enkpay.com/contact">Quick
                                            Help</a>
                                    </li>
                        ...
                        <li class="c-nav-menu__item c-nav-menu__item--green">
                            <a href="https://enkpay.com/login">Login</a>
                        </li>
                        <li class="c-nav-menu__item--cta">
                            <a href="https://enkpay.com/register" data-track="" data-track-section="Nav"
                                class="c-button c-button c-button--primary">
                                Get Started
                            </a>
                        </li>
                        <li class="c-nav-menu__item u-has-dropdown c-nav-menu__item--countries">
                            <a href="https://paystack.com/pricing#">
                                <span class="u-flag-icon u-flag-icon--ng"></span>
                            </a>
                            <div
                                class="c-dropdown c-dropdown--flip c-dropdown--reversed c-dropdown--sm u-text--no-wrap">
                                <ul class="c-nav-menu u-text--left">
                                    <li class="c-nav-menu__item">
                                        <a href="https://paystack.com/gh/pricing?localeUpdate=true">
                                            <span class="u-flag-icon u-flag-icon--gh"></span><span>Ghana</span>
                                        </a>
                                    </li>
                                    <li class="c-nav-menu__item">
                                        <a href="https://paystack.com/kenya">
                                            <span class="u-flag-icon u-flag-icon--ke"></span><span>Kenya</span>
                                        </a>
                                    </li>
                                    <li class="c-nav-menu__item">
                                        <a href="https://paystack.com/za/pricing?localeUpdate=true">
                                            <span class="u-flag-icon u-flag-icon--za"></span><span>South Africa</span>
                                        </a>
                                    </li>
                                    <li class="c-nav-menu__item">
                                        <a href="https://paystack.com/countries">
            ...
            <div class="c-nav c-nav--mobile-only c-nav--green">
                <div class="c-nav__header">
                    <div class="c-nav--left">
                        <a href="https://enkpay.com/" class="c-nav__logo">
                            <img src="https://enkpay.com/asset/wp-content/uploads/sites/110/2022/11/fintex-logo.png" height="28" width="150" height="100" width="100">
                            ...
                            <ul class="c-nav-menu">
                                ...
                                <li class="c-nav-menu__item c-nav-menu__item--cta">
                                    <a class="c-button c-button--primary u-text-center c-button--full-width c-button--lg"
                                        href="https://enkpay.com/register" data-track=""
                        ...
                        <div id="js-sub-nav">
                            ...
                            <div class="c-body">
                                <div class="c-nav-menu-links" data-menu-link-group="why-paystack">
                                    <ul class="c-nav-menu__group">
                                        <li class="c-nav-menu__item"><a
                                                href="https://paystack.com/why-choose-paystack">Why Choose Paystack</a>
                                        </li>
                                        <li class="c-nav-menu__item"><a
                                                href="https://paystack.com/success-rates">Success Rates</a></li>
                                        <li class="c-nav-menu__item"><a href="https://paystack.com/demo">Demo</a></li>
                                    </ul>
                                    <ul class="c-nav-menu__group">
                                        <div class="c-nav-menu__label">Your Growth Stage</div>
                                        <li class="c-nav-menu__item"><a href="https://paystack.com/entrepreneurs">For
                                                Entrepreneurs</a></li>
                                        <li class="c-nav-menu__item"><a href="https://paystack.com/corporates">For
                                                Corporates</a></li>
                                        <li class="c-nav-menu__item"><a href="https://paystack.com/internationals">For
                                                Global Brands</a></li>
                                        <li class="c-nav-menu__item"><a href="https://paystack.com/startups">For
                                                Startups</a></li>
                                    </ul>
                                    <ul class="c-nav-menu__group">
                                        <div class="c-nav-menu__label">Your Business Type</div>
                                        <li class="c-nav-menu__item"><a href="https://paystack.com/fintech">For
                                                Fintechs</a></li>
                                        <li class="c-nav-menu__item"><a href="https://paystack.com/service-partners">For
                                                Agents</a></li>
                                        <li class="c-nav-menu__item"><a href="https://paystack.com/schools">For
                                                Schools</a></li>
                                        <li class="c-nav-menu__item"><a href="https://paystack.com/betting">For
                                                Betting</a></li>
                                    </ul>
                                </div>
                                <div class="c-nav-menu-links" data-menu-link-group="learn">
                                    <ul class="c-nav-menu__group">
                                        <li class="c-nav-menu__item"><a href="https://paystack.com/blog">Blog</a></li>
                                        <li class="c-nav-menu__item"><a href="https://paystack.com/guides">Guides</a>
                                        </li>
                                        <li class="c-nav-menu__item"><a target="_blank" rel="noopener"
                                                href="https://paystack.com/tutorials">Video Tutorials</a></li>
                                        <li class="c-nav-menu__item"><a target="_blank" rel="noopener"
                                                href="https://decodefintech.com/">Decode Fintech</a></li>
                                        <li class="c-nav-menu__item"><a target="_blank" rel="noopener"
                                                href="https://paystack.com/commerce">Commerce</a></li>
                                    </ul>
                                    <ul class="c-nav-menu__group">
                                        <div class="c-nav-menu__label">Company</div>
                                        <li class="c-nav-menu__item"><a href="https://paystack.com/about">About Us</a>
                                        </li>
                                        <li class="c-nav-menu__item"><a
                                                href="https://paystack.com/compliance">Compliance</a></li>
                                        <li class="c-nav-menu__item"><a href="https://paystack.com/careers">Careers</a>
                                        </li>
                                        <li class="c-nav-menu__item"><a href="https://paystack.com/brand">Brand</a></li>
                                        <li class="c-nav-menu__item"><a href="https://paystack.com/media">Media Kit</a>
                                        </li>
                                        <li class="c-nav-menu__item"><a href="https://paystack.com/terms">Privacy &amp;
                                                Terms</a></li>
                                    </ul>
                                </div>
                                <div class="c-nav-menu-links" data-menu-link-group="developers">
                                    <ul class="c-nav-menu__group">
                                        <li class="c-nav-menu__item"><a
                                                href="https://paystack.com/developers">Overview</a></li>
                                        <li class="c-nav-menu__item"><a
                                                href="https://developers.paystack.co/">Documentation</a></li>
                                        <li class="c-nav-menu__item"><a
                                                href="https://paystack.com/integrations">Integrations</a></li>
                                        <li class="c-nav-menu__item"><a href="https://paystack.com/status">Status</a>
                                        </li>
                                    </ul>
                                </div>
                                <div class="c-nav-menu-links" data-menu-link-group="support">
                                    <ul class="c-nav-menu__group">
                                        <li class="c-nav-menu__item"><a target="_blank" rel="noopener"
                                                href="https://paystack.com/help">Quick Help</a></li>
                                        <li class="c-nav-menu__item"><a href="https://paystack.com/contact">Contact
                                                Us</a></li>
                                        <li class="c-nav-menu__item"><a href="https://paystack.com/lookup">Why was I
                                                debited?</a></li>
                                    </ul>
                                </div>
                            </div>
    ...
    <section class="l-section l-section--hero l-section-- l-section--green" id="hero">
        ...
        <div class="c-hero c-hero--pricing">
            <div class="c-hero__body">
                <div class="c-hero__pricing-switch">
                    <p>Pricing for Nigeria</p>
                </div>
                <div class="c-hero__heading">
                    <h1>Simple, fair pricing</h1>
                    <p class="u-text-summary">ENKPAY only makes money when you do.</p>
                </div>
                    ...
                    <div class="c-pricing-cards">
                        <div class="u-flex">
                            <div class="u-flex-child">
                                <div class="c-card c-card--pricing ">
                                    <div class="c-card__header">
                                        <h5 class="u-text--weight-normal">
                                            For Payment Gateway
                                        </h5>
                                        <h3>
                                            <span class="u-text--2x">
                                                1.4%
                                            </span>
                                        </h3>
                                    </div>
                            ...
                            <div class="u-flex-child">
                                <div class="c-card c-card--pricing ">
                                    ...
                                    <div class="c-card__body">
                                        <ul class="u-list u-list--green">
                                            <li>
                                                We cap all transactions at ₦150
                                            </li>
                                            <li>
                                                Inbound Transaction at ₦15
                                            </li>
                                            <li>
                                                Funds Transfer at ₦25
                                            </li>
                                        </ul>
                                    </div>
                                </div>
    ...
    <section class="l-section l-section--pad-top l-section--pad-bottom l-section--white">
        ...
        <div class="l-container l-container--">
            <div class="c-table c-table--pricing">
                <h4 class="u-h4-bolder">Transfers</h4>
                <div class="c-table__body">
                    <div class="c-table__row c-table__row--has-border">
                        <div class="c-table__column c-table__column--xs">
                            <span class="c-table__icon"></span>
                        </div>
                        <div class="c-table__column c-table__column--full-width">Transfers of any amount</div>
                        <div class="c-table__column c-table__column--full-width u-font--bold u-text--right">NGN 25 per
                            Transfer</div>
                    </div>
            ...
            <div class="c-table c-table--pricing">
                <h4 class="u-h4-bolder">Virtual Accounts</h4>
                <div class="c-table__body">
                    <div class="c-table__row c-table__row--has-border">
                        <div class="c-table__column c-table__column--xs">
                            <span class="c-table__icon"></span>
                        </div>
                        <div class="c-table__column c-table__column--full-width">Dedicated Virtual Accounts (DVA)</div>
                        <div class="c-table__column c-table__column--full-width u-font--bold u-text--right">1% per
                            transaction (capped at NGN 200)</div>
                    </div>
                </div>
            </div>

            <div class="c-table c-table--pricing">
                <h4 class="u-h4-bolder">Terminal</h4>
                <div class="c-table__body">
                    <div class="c-table__row c-table__row--has-border">
                        <div class="c-table__column c-table__column--xs">
                            <span class="c-table__icon"></span>
                        </div>
                        <div class="c-table__column c-table__column--full-width">Native Linux Terminal (Outright sales)</div>
                        <div class="c-table__column c-table__column--full-width u-font--bold u-text--right">NGN 60,000
                            per device</div>
                    </div>
                    ...
                    <div class="c-table__row c-table__row--has-border">
                        ...
                        <div class="c-table__column c-table__column--full-width">Native Linux Terminal (Lease sales)</div>
                        <div class="c-table__column c-table__column--full-width u-font--bold u-text--right">NGN 25,000
                            per device</div>
                    </div>
                    ...
                    <div class="c-table__row c-table__row--has-border">
                        ...
                        <div class="c-table__column c-table__column--full-width">Andriod Terminal (Outright sales)</div>
                        <div class="c-table__column c-table__column--full-width u-font--bold u-text--right">NGN 90,000
                            per device</div>
                    </div>
                    ...
                    <div class="c-table__row c-table__row--has-border">
                        ...
                        <div class="c-table__column c-table__column--full-width">Andriod Terminal (Lease sales)</div>
                        <div class="c-table__column c-table__column--full-width u-font--bold u-text--right">NGN 30,000
                            per device</div>
                    </div>
    ...
    <section class="l-section l-section--pad-top l-section--pad-bottom l-section--offwhite">
        ...
        <div class="l-container l-container--lg">
            ...
            <div class="l-grid l-grid--has-gutters c-faqs__grid">
                <div class="l-grid__column l-grid__column--4 c-faqs__left">
                    <h2 class="c-faqs__title">Common <br>Questions</h2>
                    <div class="c-faqs__footer">
                        <h4 class="u-text--2x u-text--muted">Have more questions?</h4>
                        <a href="https://paystack.com/help" class="c-button c-button--primary c-button--link">
                            <span class="c-button__icon"><svg width="20" height="20" viewBox="0 0 20 20" fill="none"
                                    ...
                                    <circle cx="10" cy="10" r="8.72781" fill="#3BB75E" fill-opacity="0" stroke="#3BB75E"
                                        stroke-width="1.45563"></circle>
                                    <path d="M9 6.37524L12.5355 9.91078L9 13.4463" stroke="#3BB75E" stroke-width="1.4"
                                        stroke-linecap="round" stroke-linejoin="round"></path>
                                </svg></span>
                            <span class="c-button__text">Check out the Help Desk</span>
                        </a>
                    </div>
                </div>
                <div class="l-grid__column l-grid__column--6 c-faqs__right">
                    <div class="c-faqs">
                        <div class="c-faq">
                            <h4 class="u-text--weight-bolder">How long does it take for me to get my money?</h4>
                            <p class="u-text--2x">You can withdraw your money instantly anytime you wish</p>
                        </div>

                        <div class="c-faq">
                            <h4 class="u-text--weight-bolder">How much does it cost to integrate Enkpay?</h4>
                            <p class="u-text--2x">Enkpay is 100% free to integrate!</p>
                        </div>



                        <div class="c-faq">
                            <h4 class="u-text--weight-bolder">Do you offer transaction volume discounts?</h4>
                            <p class="u-text--2x">Yup! Merchants who process large volumes enjoy a discount on the
                                transaction fee.</p>
                        </div>

                        <div class="c-faq">
                            <h4 class="u-text--weight-bolder">Are you able to offer flat rate pricing for any orginization?</h4>
                            <p class="u-text--2x">Yes! We offer flat rate pricing
                                institutions. Kindly contact us at info@enkpay.com to learn more about flat rate.</p>
                        </div>

                    </div>
                </div>
            </div>
            <div class="c-faqs__footer u-mobile-only">
                <a href="https://enkpay.com/contact" class="c-button c-button--primary c-button--link">
                    <span class="c-button__icon"><svg width="20" height="20" viewBox="0 0 20 20" fill="none"
                            xmlns="http://www.w3.org/2000/svg">
                            <rect width="16" height="16" fill="#3BB75E" fill-opacity="0" transform="translate(2 2)">
                            </rect>
                            <circle cx="10" cy="10" r="8.72781" fill="#3BB75E" fill-opacity="0" stroke="#3BB75E"
                                stroke-width="1.45563"></circle>
                            <path d="M9 6.37524L12.5355 9.91078L9 13.4463" stroke="#3BB75E" stroke-width="1.4"
        ...
        <div class="l-container l-container--lg">
            ...
            <div class="c-section-header c-section-header--left c-section-header--spaced-bottom">
                <div class="c-section-header__body">
                    <h2>What do you get for this price?</h2>
                    <p class="u-text-summary">Enkpay is a complete payments solution for businesses of every type, and
                        at every scale.</p>
                ...
                <div class="c-feature__left">
                    <div class="c-feature__media">
                        ...
                        <figure class="c-feature__image">
                            <div js-animate-in-view="" data-offset="40" class="u-animate" style="opacity: 1;">
                                <img class="u-lazyload"
                                    src="{{url('')}}/asset/pricing_files/Collect-Payments-for-Multiple-Channels-1.1.gif"
                                    alt="Collect Payments For Multiple Channels 1 1">
                            </div>
                        </figure>
                    </div>
                </div>
                <div class="c-feature__right">
                    ...
                    <div class="c-feature__body">
                        <div class="c-feature__text">
                            ...
                            <p>Give your customers the gift of modern, frictionless, painless payments. Integrate
                                Enkpay once and let your customers pay you however they want.</p>
                        </div>
            ...
            <div class="c-feature ">
                ...
                <div class="c-feature__right">
                    ...
                    <div class="c-feature__entry">

                        <div class="c-feature__body">
                            <div class="c-feature__text">
                                <h3>Protect yourself and your customers with advanced fraud detection</h3>
                                <p>Enkpay’s combination of automated and manual fraud systems protect you from
                                    fraudulent transactions and associated chargeback claims.</p>
                            </div>
            ...
            <div class="c-feature c-feature--reversed">
                <div class="c-feature__left">
                    <div class="c-feature__media">
                        ...
                        <figure class="c-feature__image">
                            <div js-animate-in-view="" data-offset="40" class="u-animate" style="opacity: 1;">
                                <img class="u-lazyload"
                                    data-src="https://assets.paystack.com/assets/img/content/_400x357_crop_center-center_82_line/Robust-Suite-of-APIs-Opt.png"
                                    data-sizes="100vw"
                                    data-srcset="https://assets.paystack.com/assets/img/content/_400x357_crop_center-center_82_line/Robust-Suite-of-APIs-Opt.png 400w, https://assets.paystack.com/assets/img/content/_800x714_crop_center-center_82_line/Robust-Suite-of-APIs-Opt.png 800w, https://assets.paystack.com/assets/img/content/_300x267_crop_center-center_60_line/Robust-Suite-of-APIs-Opt.png 300w, https://assets.paystack.com/assets/img/content/_600x535_crop_center-center_60_line/Robust-Suite-of-APIs-Opt.png 600w, https://assets.paystack.com/assets/img/content/_768x685_crop_center-center_60_line/Robust-Suite-of-APIs-Opt.png 768w"
                                    alt="Robust Suite Of Apis Opt">
                            </div>
                        </figure>
                    </div>
                </div>
                <div class="c-feature__right">
                    ...
                    <div class="c-feature__body">
                        <div class="c-feature__text">
                            <h3>Build custom payments experiences with well-documented APIs</h3>
                            <p>Developers love our thorough, well-documented APIs that let you to build everything from
                                simple weekend projects, to complex financial products serving hundreds of thousands of
                                customers. If you can imagine it, you can build it with Enkpay.</p>
                        </div>
                        ...
                        <div class="c-feature__cta">
                            <a href="https://enkpay.com/" target="_blank"
                                class="c-button c-button--primary c-button--link">
                                <span class="c-button__icon">
                                    <svg width="20" height="20" viewBox="0 0 20 20" fill="none"
                                        xmlns="http://www.w3.org/2000/svg">
                                        <rect width="16" height="16" fill="#3BB75E" fill-opacity="0"
                                            transform="translate(2 2)"></rect>
                                        <circle cx="10" cy="10" r="8.72781" fill="#3BB75E" fill-opacity="0"
                                            stroke="#3BB75E" stroke-width="1.45563"></circle>
                                        <path d="M9 6.37524L12.5355 9.91078L9 13.4463" stroke="#3BB75E"
                                            stroke-width="1.4" stroke-linecap="round" stroke-linejoin="round"></path>
                                    </svg>
                                </span>
                                <span class="c-button__text">
                                    Enkpay API Quickstart
                                </span>
                            </a>
                        </div>
                    </div>
                ...
                <div class="c-feature__right">
                    ...
                    <div class="c-feature__body">
                        <div class="c-feature__text">
                            ...
                            <p>ENKPAY provides detailed reporting, alerts, and exports, so you and your team are
                                always on top of business.</p>
                        </div>
                        ...
                        <div class="c-feature__benefits u-flex">
                            <ul class="u-list u-list--green ">
                                ...
                                <li>Granular user permissions lets you control the info each member of your team has
                                    access to</li>
            ...
            <div class="c-feature c-feature--reversed">
                <div class="c-feature__left">
                    <div class="c-feature__media">
                        ...
                        <figure class="c-feature__image">
                            <div js-animate-in-view="" data-offset="40" class="u-animate" style="opacity: 1;">
                                <img class="u-lazyload"
                                    data-src="https://assets.paystack.com/assets/img/content/_400x263_crop_center-center_82_line/Customer-Success-at-Work.jpg"
                                    data-sizes="100vw"
                                    data-srcset="https://assets.paystack.com/assets/img/content/_400x263_crop_center-center_82_line/Customer-Success-at-Work.jpg 400w, https://assets.paystack.com/assets/img/content/_800x526_crop_center-center_82_line/Customer-Success-at-Work.jpg 800w, https://assets.paystack.com/assets/img/content/_300x197_crop_center-center_60_line/Customer-Success-at-Work.jpg 300w, https://assets.paystack.com/assets/img/content/_600x394_crop_center-center_60_line/Customer-Success-at-Work.jpg 600w, https://assets.paystack.com/assets/img/content/_768x504_crop_center-center_60_line/Customer-Success-at-Work.jpg 768w"
                                    alt="Customer Success at Work">
                ...
                <div class="c-feature__right">
                    ...
                    <div class="c-feature__entry">
                        ...
                        <div class="c-feature__body">
                            <div class="c-feature__text">
                                <h3>Get attentive, empathetic help 24/7</h3>
                                <p>Our Customer Success team is available around the clock to support you, and they’re
                                    empowered to resolve issues as quickly as possible.</p>
                            </div>
    ...
    <section class="l-section l-section--padded-xs l-section--md l-section--white">
        <div js-animate-in-view="" class="c-section-pattern c-section-pattern--curved u-animate" style="opacity: 1;">
        </div>
        <div class="l-container l-container--lg">
            <div class="c-signup">
                <div class="c-signup__left">
                    <p class="u-text-summary">Try Enkpay Now </p>
                    <div js-animate-in-view="" data-animation="slideUp" data-offset="80" class="u-animate">
                        <h2>Start accepting payments in just 10 minutes</h2>
                    </div>
                </div>
                <div class="c-signup__right">
                    <div class="c-signup__cta">
                        <a href="https://enkpay.com/register"
                            class="c-button--lg c-button c-button--primary" data-track="" data-track-section="Footer">
                            Get Started
                        </a>
                        <a href="https://paystack.com/pricing"
                            class="c-button c-button--primary c-button--demo c-button--link">
    ...
    <script>!function () { function n() { var n = document.getElementById("js-mobile-nav-trigger"), e = document.querySelector(".c-nav.c-nav--mobile-only"), t = !1; n.addEventListener("click", function () { var i = t ? "remove" : "add"; n.classList[i]("c-nav__trigger--is-active"), e.classList[i]("c-nav--is-opened"), t = !t }) } function e(n, e, t) { new window.Waypoint({ element: n, handler: e, offset: t + "px" }) } function t() { for (var n = ["blue", "green", "offwhite", "white", "grey", "dark-blue"], t = document.getElementsByClassName("l-section"), i = 65, r = function (r) { var o = t[r]; e(o, function (e) { for (var t = document.getElementsByClassName("c-nav"), i = function (i) { var r = t[i], a = n.find(function (n) { return r.classList.contains("c-nav--" + n) }), c = "up" === e ? o.previousElementSibling : o, s = n.find(function (n) { return c.classList.contains("l-section--" + n) }); a && r.classList.remove("c-nav--" + a), r.classList.add("c-nav--" + s) }, r = 0; r < t.length; r++)i(r) }, i) }, o = 0; o < t.length; o++)r(o) } Array.prototype.find || Object.defineProperty(Array.prototype, "find", { value: function (n) { if (null == this) throw new TypeError('"this" is null or not defined'); var e = Object(this), t = e.length >>> 0; if ("function" != typeof n) throw new TypeError("predicate must be a function"); for (var i = arguments[1], r = 0; r < t;) { var o = e[r]; if (n.call(i, o, r, e)) return o; r++ } }, configurable: !0, writable: !0 }), n(), t() }();
        ...
        var currency = 'ngn';
        function moveCursorToEnd(e) { var t = window.scrollX, n = window.scrollY; e.focus(), window.scrollTo(t, n); var a = e.value.length; e.selectionStart = a, e.selectionEnd = a } function formatNumber(e) { return String(e).split("").reverse().join("").replace(/(\d{3}\B)/g, "$1,").split("").reverse().join("") } function calculate() { var e = amountInput.value, t = computePaystackCharge[currency](e); updateSettlementValue(t.paystackCharge, e, t.vatCharge) } var amountInput = document.getElementById("js-calculator-amount"), _window = window, currency = _window.currency, updateSettlementValue = function (e, t) { var n = arguments.length > 2 && void 0 !== arguments[2] ? arguments[2] : 0, a = document.getElementById("js-paystack-fee"), r = document.getElementById("js-paystack-settlement"); a.innerHTML = formatNumber(e), r.innerHTML = formatNumber((t - e - n).toFixed(2)), "ngn" === currency.toLowerCase() && (document.getElementById("js-additional-100").style.display = t < 2500 ? "none" : ""), "zar" === currency.toLowerCase() && (document.getElementById("js-additional-100").style.display = t < 10 ? "none" : "") }, computePaystackCharge = { ngn: function (e) { var t = 100 * e, n = t < 25e4 ? 0 : 1e4, a = Math.ceil(.015 * t) + n, r = Math.min(a / 100, 2e3).toFixed(2); return { paystackCharge: r } }, ghs: function (e) { var t = 0, n = 100 * e, a = Math.ceil(.0195 * n) + t, r = (a / 100).toFixed(2); return { paystackCharge: r } }, zar: function (e) { var t = .15, n = 100 * e, a = n < 1e3 ? 0 : 100, r = Math.ceil(.029 * n + a), o = r / 100, c = Math.ceil((.029 * n + a) * t) / 100; return { paystackCharge: o, vatCharge: c } } }; amountInput.addEventListener("input", function (e) { e.data && Number.isNaN(e.data) && e.preventDefault(), calculate() }), moveCursorToEnd(amountInput), calculate();
        !function () { var e, t = document.getElementsByClassName("c-footer__header"); for (e = 0; e < t.length; e++)t[e].addEventListener("click", function () { this.classList.toggle("c-footer__header--active"); var e = this.nextElementSibling; e.style.maxHeight ? e.style.maxHeight = null : e.style.maxHeight = e.scrollHeight + "px" }) }();</script>
    <script>(function () { var js = "window['__CF$cv$params']={r:'7f0dac6fef1eeeb4'};_cpo=document.createElement('script');_cpo.nonce='',_cpo.src='/cdn-cgi/challenge-platform/scripts/invisible.js',document.getElementsByTagName('head')[0].appendChild(_cpo);"; var _0xh = document.createElement('iframe'); _0xh.height = 1; _0xh.width = 1; _0xh.style.position = 'absolute'; _0xh.style.top = 0; _0xh.style.left = 0; _0xh.style.border = 'none'; _0xh.style.visibility = 'hidden'; document.body.appendChild(_0xh); function handler() { var _0xi = _0xh.contentDocument || _0xh.contentWindow.document; if (_0xi) { var _0xj = _0xi.createElement('script'); _0xj.innerHTML = js; _0xi.getElementsByTagName('head')[0].appendChild(_0xj); } } if (document.readyState !== 'loading') { handler(); } else if (window.addEventListener) { document.addEventListener('DOMContentLoaded', handler); } else { var prev = document.onreadystatechange || function () { }; document.onreadystatechange = function (e) { prev(e); if (document.readyState !== 'loading') { document.onreadystatechange = prev; handler(); } }; } })();</script>
    <iframe height="1" width="1" style="position: absolute; top: 0px; left: 0px; border: none; visibility: hidden;"
        src="{{url('')}}/asset/pricing_files/saved_resource.html"></iframe>
