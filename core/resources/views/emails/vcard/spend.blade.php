    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-md-4" style="text-align: left;padding: 26px;padding-bottom: 17;padding-left: 74px;padding-right: 0px;border-color: var(--bs-card-bg);background: #f2f2f2;">
                <h1 style="font-size: 32px;"><strong>CARD DEBIT&nbsp;</strong></h1>

                <p style="font-size: 14px;font-weight: bold;"> Hi, {{ $data1['first_name'] }}</p>

                <p>We like to inform you that your card got charged USD {{number_format($data1['amount'], 2)}}</p>


                <p class="text-muted mb-0" style="--bs-body-font-weight: normal;height: 0px;width: 566px;text-align: left;font-size: 11px;">Copyright © 2023 ENKPAY</p>
