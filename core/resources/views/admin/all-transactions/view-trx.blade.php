                    ...
                    <div class="row">
                                                ...
                                                <div class="card info">
                                                    <div class="card-body d-flex align-items-center p-3">
                                                        ...
                                                        <div class="info-content">
                                                            ...
                                                            <span
                                                                class="fs-16">Account No - {{ $val->sender_account_no ?? $val->receiver_account_no ??  $val->sender_bank ?? $val->receiver_bank  }}</span>
                                                ...
                                                <div class="card-body d-flex align-items-center p-3">
                                                    <div class="info-icon pe-3 ">
                                                        <svg width="24" height="24" viewBox="0 0 24 24" fill="none"
                                                             xmlns="http://www.w3.org/2000/svg">
                                                            <path
                                                                d="M17.208 0C21.276 0 24 2.856 24 7.104V16.9092C24 21.1452 21.276 24 17.208 24H6.804C2.736 24 0 21.1452 0 16.9092V7.104C0 2.856 2.736 0 6.804 0H17.208ZM11.988 10.1772C11.412 10.1772 10.944 10.656 10.944 11.2332V16.5372C10.944 17.1132 11.412 17.5812 11.988 17.5812C12.576 17.5812 13.044 17.1132 13.044 16.5372V11.2332C13.044 10.656 12.576 10.1772 11.988 10.1772ZM12.012 6.3732C11.424 6.3732 10.956 6.8412 10.956 7.4292C10.956 8.004 11.424 8.4732 11.988 8.4732C12.588 8.4732 13.056 8.004 13.056 7.4292C13.056 6.8412 12.588 6.3732 12.012 6.3732Z"
                                                                fill="#1DAAFF"/>
                                                        </svg>
                        ...
                        <div class="col-xl-6">
                                ...
                                <div class="col-xl-12 col-lg-12 col-sm-12">
                                    <div class="card overflow-hidden">
                                        <div class="text-center p-5 overlay-box"
                                             style="background: rgb(255 255 255); opacity:2;">
                                            <img src="{{url('')}}/asset/img/success.gif" width="200" height="150"
                                                 alt="">
                                            <h3 class="mt-3 mb-0 text-primary">Congratulations</h3>
                                            <p class="mt-2 mb-0 text-small text-dark">You earned NGN 1 Bonus on this
                                                transaction</p>
                            ...
                            @elseif($val->transaction_type == "BankTransfer" && $val->status == 0)
                                <div class="col-xl-12 col-lg-12 col-sm-12">
                                    <div class="card overflow-hidden">
                                        <div class="text-center p-5 overlay2-box"
                                             style="background: rgb(229 239 241); opacity:2;">
                                            <img src="{{url('')}}/asset/img/pending.gif" width="150" height="150"
                                                 alt="">
                                            <h3 class="mt-3 mb-0 text-primary">Transaction in Progress</h3>
                                            <p class="mt-2 mb-0 text-small text-dark">Click Check Status to update
                                        ...
                                        <div class="card-footer mt-0">
                                            <a href="checktrxstatus?id={{ $val->ref_trans_id }}"
                                               class="btn btn-warning btn-lg btn-block">Check Status</a>
                                        </div>

                                        <div class="card-footer mt-0">
                                            <a href="refundtrx?ref_trans_id={{ $val->ref_trans_id }}"
                                               class="btn btn-primary btn-lg btn-block">Refund Tranaction</a>
                                        </div>
                                    </div>
                                </div>
