            ...
            <div class="col-md-6">
                ...
                <div class="row">
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-12">
                            <form method="POST"
                                action="{{route('activate.customer', ['user_id' => $id ])}}">
                                @csrf
                                @method('POST')
                        ...
                        <div class="col-lg-12">
                            <form method="POST"
                                action="{{route('deactivate.customer', ['user_id' => $id ])}}">
                                @csrf
                                @method('POST')

                                <button type="submit" class="btn btn-warning btn-sm mt-2">Deactivate Customer</button>
                            </form>
                        </div>
                        @endif
