                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-lg-10">
                                        ...
                                        <div class="custom-control custom-control-alternative custom-checkbox">
                                            ...
                                            <input type="checkbox" name="is_identification_verified"
                                                id=" customCheckLogin9" class="custom-control-input" value="1" checked>
                                            @else
                                            <input type="checkbox" name="is_identification_verified"
                                                id=" customCheckLogin9" class="custom-control-input" value="1">
                                            @endif
                ...
                <div class="col-md-6">
                    ...
                    <div class="row">
                                ...
                                <div class="card-body text-center">
                                    <div class="card-img-actions d-inline-block mb-3">
                                        <img class="img-fluid rounded-circle"
                                            src="https://enkpayapp.enkwave.com/public/upload/identification_image/{{$client->identification_image}}"
                        ...
                        <div class="col-lg-4">
                            <div class="card">
                                <div class="card-body text-center">
                                    <div class="card-img-actions d-inline-block mb-3">
                                        <img class="img-fluid rounded-circle"
                                            src="https://enkpayapp.enkwave.com/public/upload/selfie/{{$client->image}}"
                                            width="120" height="120" alt="">
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="col-lg-4">
                            <div class="card">
                                <div class="card-body text-center">
                                    <div class="card-img-actions d-inline-block mb-3">
                                        <img class="img-fluid rounded-circle"
                                            src="https://enkpayapp.enkwave.com/public/upload/utilitybill/{{$client->utility_bill}}"
                                            width="120" height="120" alt="">
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-12">
                                <form method="POST" action="{{route('activate.customer', ['user_id' => $id ])}}">
                                    @csrf
                                    @method('POST')

                                    <button type="submit" class="btn btn-success btn-sm mt-2">Verify Customer</button>
                                </form>
                            </div>
                            @elseif($is_identification_verified == 1)
                            <div class="col-lg-12">
                                <form method="POST" action="{{route('deactivate.customer', ['user_id' => $id ])}}">
                                    @csrf
                                    @method('POST')

                                    <button type="submit" class="btn btn-warning btn-sm mt-2">Deactivate
                                        Customer</button>
                                </form>
                            </div>
                            @endif
                            ...
                            <div class="card-body">
                                <div class="d-sm-flex align-item-sm-center flex-sm-nowrap">
                                    <div>
                                        ...
                                        <ul class="list list-unstyled mb-0">
                                            <h2><span class="text-default text-sm">{{number_format($vas_count)}}</span>
                                            </h2>
                                        </ul>
                                    </div>
                                </div>
                            ...
                            <div class="card-body">
                                <div class="d-sm-flex align-item-sm-center flex-sm-nowrap">
                                    <div>
                                        ...
                                        <ul class="list list-unstyled mb-0">
                                            <h2><span class="text-default text-sm">{{number_format($pos_count)}}</span>
                                            </h2>
                                        </ul>
                                    </div>
                                </div>
                        ...
                        <table class="table table-flush" id="datatable">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td><span class="badge rounded-pill bg-success text-white">Transfer Active</span>
                                    </td>
                                    @else
                                    ...
                                    <td>
                                        <form method="POST"
                                            ...
                                            <button type="submit"
                                                class="btn btn-warning btn-sm mt-2">Deactivate</button>
                                        </form>
                                    </td>
                                    @else
                                    <td>
                        ...
                        <form action="{{route('add.terminal')}}" method="post">
                            ...
                            <div class="row">
                                ...
                                <div class="form-group">
                                    <div class="col-lg-12">
                                        <div class="input-group">
                                            <input type="number" required placeholder="Enter Vaccount"
                                                name="v_account_no" value=" " class="form-control">
                                        </div>
                                    </div>
                                </div>
                        ...
                        <form action="{{route('terminal.payment')}}" method="post">
                            ...
                            <div class="row">
                                <div class="form-group">
                                    <div class="col-lg-12">
                                        <div class="input-group">
                                            <input type="number" required name="serial_no" value="{{$terminal_id ?? "
                                                12345"}}"placeholder="Enter Terminla Serial No" class="form-control">
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    <button type="submit" class="btn btn-success btn-sm mt-3">{{__('Add
                                        Payment')}}</button>
                                </div>
