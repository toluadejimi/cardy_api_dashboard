            ...
            <div class="Layout_container__NnjuH">
                <div class="shared_auth_container__qG_A4">
                    ...
                    <div class="shared_auth_content__t2BiJ">
                        ...
                        <strong>{{$email}}</strong>.Kindly check your inbox, if not found check your spam folder.

                        <br>   <a class="my-2" style="color: aliceblue;" href="/personal-register"> Change Email</a>
                        ...
                        <form action="verify-code?email={{ $email }}" method="post">
                            @csrf
