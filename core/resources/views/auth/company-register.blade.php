...
<head>
    ...
    <link rel="stylesheet" href="{{ url('') }}/asset/_next/static/css/fadbcd57e6102439.css"/>
        ...
        <div>
            <div class="Header_headerContainer__GeVud">
                ...
                <div class="Header_farLeft__NHvAf"><a class="Header_logo__gVzWQ" rel="noopener noreferrer"
                                                      href="https://enkpay.com">
                        <svg width="149" height="40" fill="none">
                            ...
                            <defs>
                                ...
                                <img src="{{ url('') }}/asset/images/white.png" height="45" width="150">
                            </defs>
                        </svg>
                    </a>
                ...
                {{-- <div class="text-white"><a  rel="noopener noreferrer"
                    href="/login">Login</a>

                <button class="btn btn-primary">Get
                    Started</button>
            </div> --}}
                <div class="Header_farRightMobile__xJozT"><a>
                    ...
                    <div class="Header_slideoutMenu__jbS0m">
                        <div class="Header_slideoutMenuContainer__qTQgn">
                            ...
                            <div class="Header_actionButtons__4YcIz"><a href="register" class="Header_signUp__aPJg2">Sign
                                    Up</a><a href="login" class="Header_login__9XpnS">Login</a>
        ...
        <div class="Layout_container__NnjuH">
            <div class="shared_auth_container__qG_A4">
                <aside class="shared_auth_aside__ms1p1">
                    <h2 class="shared_auth_asideTitle__S1qBM">Join the Family</h2>
                    <p class="shared_auth_asideSubtitle__BAQ1J">Start enjoying swift transactions</p>

                    <hr>
                    <a href="register" style="color: aliceblue;"
                       class=" shared_auth_asideButton__Uh6HW Button_button__PjVhE Button_outline__EsWgH">For
                        Business</a>
                    ...
                    <a class="mt-0 mb-1"
                       href="https://play.google.com/store/apps/details?id=com.enk_pay_project.mobileapp">
                        <img src="{{ url('') }}/asset/images/gg.png" height="60" width="200"
                             alt="Descriptive text for the image">
                    </a>

                    <a class="mb-2" href="https://play.google.com/store/apps/details?id=com.enk_pay_project.mobileapp">
                        <img src="{{ url('') }}/asset/images/ios.png" height="55" width="200"
                             alt="Descriptive text for the image">
                    </a>
                ...
                <div class="shared_auth_content__t2BiJ">
                    ...
                    <p class="">Enter your vaild details</p>
                    ...
                    <form action="business-register" method="POST">
                            ...
                            <div class="col-6">
                                ...
                                <div class="Input_inputGroup__cOu_0">
                                    ...
                                    <div class="Input_inputGroup__cOu_0">
                                        ...
                                        <label class="Input_label__5uJx3">Contact Email</label><input
                                            class="Input_input__gCIPK" name="email" placeholder="Enter contact email"
                                            required type="email"/>
                            ...
                            <div class="col-6">
                                ...
                                <div class="Input_inputGroup__cOu_0">
                                    ...
                                    <div class="Input_inputGroup__cOu_0">
                                        ...
                                        <label class="Input_label__5uJx3">Business Name</label><input
                                            class="Input_input__gCIPK" name="business_name"
                                            placeholder="Enter Business Name" required type="text"/>
                            ...
                            <div class="col-6">
                                ...
                                <div class="Input_inputGroup__cOu_0">
                                    ...
                                    <div class="Input_inputGroup__cOu_0">
                                        ...
                                        <label class="Input_label__5uJx3">Contact Phone Number</label><input
                                            class="Input_input__gCIPK" name="phone" value="+234"
                                            placeholder="Contact Phone Number" required type="text"/>
                            ...
                            <div class="col-6">
                                ...
                                <div class="Input_inputGroup__cOu_0">
                                    ...
                                    <div class="Input_inputGroup__cOu_0">
                                        ...
                                        <label class="Input_label__5uJx3">Contact First Name</label><input
                                            class="Input_input__gCIPK" name="first_name" placeholder="Enter first name"
                                            required type="text"/>
                        ...
                        <div class="row">
                            ...
                            <div class="col-6">
                                ...
                                <div class="Input_inputGroup__cOu_0">
                                    ...
                                    <div class="Input_inputGroup__cOu_0">
                                        ...
                                        <label class="Input_label__5uJx3">Contact last Name</label><input
                                            class="Input_input__gCIPK" name="last_name" placeholder="Enter first name"
                                            required type="text"/>
                            ...
                            <div class="col-6">
                                ...
                                <label class="Input_label__5uJx3">Country</label>
                        ...
                        <button class="shared_auth_button__6ykOn Button_button__PjVhE Button_primary___XGO6"
                                type="submit">Continue
                        </button>

                        <div class=""><br/>
                            <p class="align-center">Already have an account? <a style="color:aliceblue;"
                                                                                rel="noopener noreferrer"
                                                                                class="strong no-decor" href="login">Sign
                                    In</a> now!</p>
                        </div>
                    </form>
