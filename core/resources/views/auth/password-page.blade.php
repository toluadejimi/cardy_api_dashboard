            ...
            <div class="Layout_container__NnjuH">
                <div class="shared_auth_container__qG_A4">
                    <aside class="shared_auth_aside__ms1p1">
                        <h2 class="shared_auth_asideTitle__S1qBM">Don’t have an account yet?</h2>
                        <p class="shared_auth_asideSubtitle__BAQ1J">Start getting to know
                            your staff and customers better today</p>
                    ...
                    <div class="shared_auth_content__t2BiJ">
                        ...
                        <h2 class="shared_auth_contentTitle__Iwznb">Sign in to ENKPAY</h2>

                        <p class="text-small">You are sigining in with  {{ $email }}<a style="color: aliceblue;" href="/login"> Change Email</a></p>
                        ...
                        <form action="{{ route('submitlogin') }}" method="post">
                            ...
                            <div class="Input_inputGroup__cOu_0">
                                ...
                                <label class="Input_label__5uJx3">Enter your Password
                                    </label><input class="Input_input__gCIPK" name="password"
                                    placeholder="" required type="password" />
                                    <input type="email" name="email" hidden class="form-control mb-2" value="{{ $email }}">
                        ...
                        <div class="show-on-small"><br />
                            <p class="align-center"> <a style="color: aliceblue;" rel="noopener noreferrer"
                                    class="strong no-decor" href="forgot-password?email={{$email}}">Forgot Password</a></p>
                        </div>
