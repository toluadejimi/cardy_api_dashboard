      ...
      <div class="col-md-12">
        <div class="nav-wrapper">
          <ul class="nav nav-pills nav-fill flex-column flex-md-row" id="tabs-icons-text" role="tablist">
            <li class="nav-item">
              <a class="nav-link mb-sm-3 mb-md-0 @if(route('user.profile')==url()->current()) active @endif"
                id="tabs-icons-text-1-tab" data-toggle="tab" href="#tabs-icons-text-1" role="tab"
                aria-controls="tabs-icons-text-1" aria-selected="true"><i class="fad fa-user"></i> Profile</a>
            </li>
            <li class="nav-item">
              <a class="nav-link mb-sm-3 mb-md-0 @if(route('user.security')==url()->current()) active @endif"
                id="tabs-icons-text-2-tab" data-toggle="tab" href="#tabs-icons-text-2" role="tab"
                aria-controls="tabs-icons-text-2" aria-selected="fadse"><i class="fad fa-cogs"></i> Security</a>
            </li>
            <li class="nav-item">
              <a class="nav-link mb-sm-3 mb-md-0 @if(route('user.api')==url()->current()) active @endif"
                id="tabs-icons-text-3-tab" data-toggle="tab" href="#tabs-icons-text-3" role="tab"
                aria-controls="tabs-icons-text-3" aria-selected="fadse"><i class="fad fa-key"></i> API Keys</a>
            </li>
            <li class="nav-item">
              <a class="nav-link mb-sm-3 mb-md-0 @if(route('user.social')==url()->current()) active @endif"
                ...
                aria-controls="tabs-icons-text-4" aria-selected="fadse"><i class="fad fa-share-square"></i> Social
                Profile</a>
            </li>
            <li class="nav-item">
              <a class="nav-link mb-sm-3 mb-md-0 @if(route('user.bank')==url()->current()) active @endif"
                ...
                aria-controls="tabs-icons-text-5" aria-selected="fadse"><i class="fad fa-university"></i> Bank
                Accounts</a>
            </li>
            <li class="nav-item">
              <a class="nav-link mb-sm-3 mb-md-0 @if(route('user.compliance')==url()->current()) active @endif"
                ...
                aria-controls="tabs-icons-text-6" aria-selected="fadse"><i class="fad fa-globe"></i> Compliance</a>
            </li>
          </ul>
        </div>
            ...
            <div class="row">
              <div class="col-md-8">
                <div class="card">
                  ...
                  <div class="card-body">
                    <form action="{{url('user/account')}}" enctype="multipart/form-data" method="post">
                      @csrf
                      <div class="form-group row">
                        <label class="col-form-label col-lg-3">{{__('Personal Info')}}</label>
                        <div class="col-lg-9">
                          <div class="row">
                      ...
                      <div class="form-group row">
                        <label class="col-form-label col-lg-3">{{__('Identification')}}</label>
                        <div class="col-lg-9">
                          <div class="row">
                            ...
                            {{-- <div class="col-lg-12 mt-3">
                              <select class="form-control select" name="identification_type" required>
                                ...
                                <option value="NIGERIAN_DRIVERS_LICENSE">DRIVER LICENSE</option>
...
{{-- 
                            ...
                            <div class="col-12 mt-3">
                              <input type="number" name="bvn" class="form-control" required placeholder="BVN"
                                value="{{$user->bvn}}">
                              <span class="form-text text-xs">{{__('Enter your Vaild BVN | Dial *565*0# to check your
                                BVN')}}</span>
                      ...
                      <div class="text-right">
                        <button type="submit" class="btn btn-warning btn-lg">{{__('Verify')}}</button>
                      </div>
                    </form>
                  </div>
                </div>
              ...
              <div class="col-md-4">
                ...
                <div class="card">
                  <div class="card-body text-center">
                    ...
                    <p class="card-text text-sm mb-2">{{__('Closing this account means you will no longer be able to
                      access this account on')}} {{$set->site_name}}</p>
                    <div class="text-right">
                      <a data-toggle="modal" data-target="#modal-formp" href="" class="btn btn-danger btn-block"><i
                          class="fa fa-trash"></i> {{__('Delete Account')}}</a>
                    </div>
                  </div>
                </div>
                  ...
                  <form action="{{url('user/account')}}" method="post">
                    ...
                    <div class="form-group row">
                      ...
                      <div class="col-lg-9">
                        ...
                        <span class="form-text text-xs">{{__('Your business name is the official name of your company.
                          It should be the same as the name on your registration documents.')}}</span>
                      </div>
                    </div>
                    <div class="form-group row">
                      ...
                      <div class="col-lg-9">
                        <div class="input-group">
                          ...
                          <input type="number" inputmode="numeric" name="phone" maxlength="14" class="form-control"
                            value="{{$user->phone}}">
                        </div>
                      </div>
                    </div>
                      ...
                      <div class="col-lg-9">
                        <div class="input-group">
                          ...
                          <input type="email" name="support_email" class="form-control"
                            placeholder="{{__('Email Address')}}" value="{{$user->support_email}}">
                        </div>
                      </div>
                    </div>
                    <div class="form-group row">
            ...
            <div class="col-md-4">
              <div class="card">
                <div class="card-body text-center">
                  ...
                  <p class="card-text text-sm">{{__('We recommend you use a square logo with dimensions 172px by 172px
        ...
        <div class="tab-pane fade @if(route('user.security')==url()->current())show active @endif"
          ...
          <div class="card">
            ...
            <div class="card-body">
              <form action="{{route('change.password')}}" method="post">
                ...
                <div class="form-group row">
                  <div class="col-lg-12">
                    <input type="password" name="password" class="form-control" placeholder="{{__('Current password')}}"
                      required>
                  </div>
                </div>
                <div class="form-group row">
          ...
          <div class="card">
            ...
            <div class="card-body">
              <div class="align-item-sm-center flex-sm-nowrap text-left">
                ...
                <ul class="text-default text-sm">
                  <li>{{__('Install an authentication app on your device. Any app that supports the Time-based One-Time
                    Password (TOTP) protocol should work.')}}</li>
                ...
                <div class="modal fade" id="modal-form2fa" tabindex="-1" role="dialog" aria-labelledby="modal-form"
                  aria-hidden="true">
                    ...
                    <div class="modal-content">
                      <div class="modal-body text-center">
                        ...
                        <form action="{{route('change.2fa')}}" method="post">
                          ...
                          <div class="form-group row">
                            <div class="col-lg-12">
                              <input type="text" pattern="\d*" name="code" class="form-control" minlength="6"
                                maxlength="6" placeholder="Six digit code" required>
        ...
        <div class="tab-pane fade @if(route('user.api')==url()->current())show active @endif" id="tabs-icons-text-3"
                ...
                <div class="form-group row">
                  <div class="col-lg-12">
                    <div class="input-group">
                      ...
                      <div class="input-group-prepend">
                        <span class="input-group-text btn-icon-clipboard" data-clipboard-text="{{$user->public_key}}"
                          title="Copy"><i class="fad fa-copy"></i></span>
                      </div>
                    </div>
                  </div>
                </div>
                <div class="form-group row">
                  <div class="col-lg-12">
                    <div class="input-group">
                      ...
                      <div class="input-group-prepend">
                        <span class="input-group-text btn-icon-clipboard" data-clipboard-text="{{$user->secret_key}}"
                          title="Copy"><i class="fad fa-copy"></i></span>
                      </div>
                    </div>
                  </div>
        ...
        <div class="tab-pane fade @if(route('user.social')==url()->current())show active @endif" id="tabs-icons-text-4"
            ...
            <div class="card-body">
              <form action="{{route('user.social')}}" method="post">
                ...
                <div class="form-group row">
                  ...
                  <div class="col-lg-10">
                    <input type="url" name="facebook" class="form-control" placeholder="Your Facebook Profile Link"
                      value="{{$user->facebook}}">
                  </div>
                </div>
                <div class="form-group row">
                  ...
                  <div class="col-lg-10">
                    <input type="url" name="twitter" class="form-control" placeholder="Your Twitter Profile Link"
                      value="{{$user->twitter}}">
                  </div>
                </div>
                <div class="form-group row">
                  ...
                  <div class="col-lg-10">
                    <input type="url" name="instagram" class="form-control" placeholder="Your Instagram Profile Link"
                ...
                <div class="form-group row">
                  ...
                  <div class="col-lg-10">
                    <input type="url" name="linkedin" class="form-control" placeholder="Your LinkedIn Profile Link"
                      value="{{$user->linkedin}}">
                  </div>
                </div>
                <div class="form-group row">
                  ...
                  <div class="col-lg-10">
                    <input type="url" name="youtube" class="form-control" placeholder="Your Youtube Channel Link"
                      value="{{$user->youtube}}">
                  </div>
                </div>
                <div class="text-right">
        ...
        <div class="tab-pane fade @if(route('user.bank')==url()->current())show active @endif" id="tabs-icons-text-5"
          ...
          <div class="row align-items-center py-4">
            <div class="col-lg-6 col-5 text-left">
              <a data-toggle="modal" data-target="#modal-formx" href="" class="btn btn-sm btn-neutral"><i
                  class="fad fa-plus"></i> {{__('Bank Account')}}</a>
            </div>
          </div>
          @endif
              ...
              <div class="modal-content">
                ...
                <div class="modal-body">
                  <form role="form" action="{{route('submit.bank')}}" method="post">
                    ...
                    <div class="form-group row">
                      <div class="col-lg-12">
                        <input type="text" name="acct_no" pattern="\d*" maxlength="12" placeholder="Account No"
                    ...
                    <div class="form-group">
                      <div class="input-group">
                        ...
                        <input class="form-control" placeholder="{{ __('Routing Number / Sort Code') }}" type="text"
          ...
          <div class="row">
            ...
            <div class="col-md-6">
              <div class="card">
                <div class="card-body">
                  <div class="row mb-2">
                    ...
                    <div class="col-6 text-right">
                      ...
                      <div class="dropdown-menu dropdown-menu-left">
                        @if($val->status==0)
                        <a class="dropdown-item" href="{{route('bank.default', ['id' => $val->id])}}"><i
                            class="fad fa-check"></i>{{__('Default')}}</a>
                        @endif
                        <a class="dropdown-item" data-toggle="modal" data-target="#modal-form{{$val->id}}" href="#"><i
                            class="fad fa-pencil"></i>{{__('Edit')}}</a>
                        <a class="dropdown-item" data-toggle="modal" data-target="#delete{{$val->id}}" href=""><i
                  ...
                  <div class="row">
                    <div class="col">
                      <p class="text-sm mb-0 font-weight-bolder text-uppercase">{{__('Default account')}}:
                        @if($val->status==1) Yes @else No @endif</p>
                      <p class="text-sm mb-0 font-weight-bolder text-uppercase">{{__('Account Name')}}:
                        {{$val->acct_name}}</p>
                      <p class="text-sm mb-0 font-weight-bolder text-uppercase">{{__('Routing No/Sort Code')}}:
                        {{$val->routing_number}}</p>
                      <p class="text-sm mb-2 font-weight-bolder text-uppercase">{{__('Account Type')}}:
                        {{$val->account_type}}</p>
                ...
                <div class="modal-content">
                  <div class="modal-body p-0">
                    <div class="card bg-white border-0 mb-0">
                      ...
                      <div class="card-body">
                        <a href="{{route('bank.delete', ['id' => $val->id])}}"
            ...
            <div class="modal fade" id="modal-form{{$val->id}}" tabindex="-1" role="dialog" aria-labelledby="modal-form"
              aria-hidden="true">
              <div class="modal-dialog modal-dialog-centered" role="document">
                <div class="modal-content">
                  <div class="modal-header">
                    ...
                    <form role="form" action="{{route('bank.edit')}}" method="post">
                      ...
                      <div class="form-group row">
                        <div class="col-lg-12">
                          <select class="form-control select" name="bank" required>
                            <option value="">{{__('Select Bank')}}</option>
                            @foreach($bnk as $xval)
                            <option value="{{$xval->id}}" @if($xval->id==$val->bank_id) selected @endif>{{$xval->name}}
                            </option>
                            @endforeach
                          </select>
                        </div>
                      ...
                      <div class="form-group row">
                        <div class="col-lg-12">
                          <select class="form-control select" name="account_type" required>
                            <option value="">{{__('Account Type')}}</option>
                            <option value="individual" @if($val->account_type=='individual') selected @endif>Individual
                            </option>
                      ...
                      <div class="form-group row">
                        <div class="col-lg-12">
                          <input type="text" name="acct_name" placeholder="Account name" class="form-control"
                            placeholder="Account Name" value="{{$val['acct_name']}}">
                        </div>
                      </div>
                      <div class="form-group row">
                        <div class="col-lg-12">
                          <input type="number" name="acct_no" placeholder="Account number" placeholder="Account No"
                            class="form-control" value="{{$val['acct_no']}}">
                      ...
                      <div class="form-group">
                        <div class="input-group">
                          ...
                          <input class="form-control" placeholder="{{ __('Routing Number / Sort Code') }}" type="text"
                            name="routing_number" value="{{$val['routing_number']}}" required>
                        </div>
                      </div>
                      <div class="text-right">
        ...
        <div class="tab-pane fade @if(route('user.compliance')==url()->current())show active @endif"
            ...
            <div class="card">
              ...
              <div class="card-body">
                ...
                <div class="form-group row">
                  ...
                  <div class="col-lg-10">
                    <input type="text" name="trading_name" @if($ver->status==1 || $user->business_level==3) disabled
                ...
                <div class="form-group row">
                  ...
                  <div class="col-lg-10">
                    <textarea type="text" name="trading_desc"
                      @if($ver->status==1 || $user->business_level==3) disabled @endif class="form-control" required>{{$ver->description}}</textarea>
                  </div>
                </div>
                <div class="form-group row">
                  <label class="col-form-label col-lg-2">{{__('Staff Size')}}</label>
                  <div class="col-lg-10">
                    <select class="form-control select" name="staff_size" @if($ver->status==1 ||
                      $user->business_level==3) disabled @endif required>
                ...
                <div class="form-group row">
                  ...
                  <div class="col-lg-10">
                    <select class="form-control select" name="industry" @if($ver->status==1 || $user->business_level==3)
                      disabled @endif id="industry" required>
                    </select>
                ...
                <div class="form-group row">
                  ...
                  <div class="col-lg-10">
                    <select class="form-control select" name="category" @if($ver->status==1 || $user->business_level==3)
                      disabled @endif id="category" required>
                    </select>
                ...
                <div class="form-group row">
                  ...
                  <div class="col-lg-10">
                    <input type="text" name="address" class="form-control" @if($ver->status==1 ||
                    $user->business_level==3) disabled @endif value="{{$ver->address}}">
                  </div>
                </div>
                <div class="form-group row">
                  <label class="col-form-label col-lg-2">{{__('Phone')}}</label>
                  <div class="col-lg-10">
                    <input type="number" name="phone" class="form-control" @if($ver->status==1 ||
                    $user->business_level==3) disabled @endif value="{{$ver->phone}}">
                  </div>
                </div>
                <div class="form-group row">
                  <label class="col-form-label col-lg-2">{{__('Email')}}</label>
                  <div class="col-lg-10">
                    <input type="email" name="email" class="form-control" @if($ver->status==1 ||
                    $user->business_level==3) disabled @endif value="{{$ver->email}}">
                  </div>
                </div>
                <div class="form-group row">
                  <label class="col-form-label col-lg-2">{{__('Website')}}</label>
                  <div class="col-lg-10">
                    <input type="url" name="website" class="form-control" @if($ver->status==1 ||
                    $user->business_level==3) disabled @endif value="{{$ver->website}}">
                  </div>
                </div>
                <div class="form-group row">
                  <label class="col-form-label col-lg-2">{{__('Business Type')}}</label>
                  <div class="col-lg-10">
                    <select class="form-control select" name="business_type" @if($ver->status==1 ||
                      $user->business_level==3) disabled @endif id="seeAnotherField" required>
                      <option value="Starter Business" @if($ver->business_type=="Starter Business") selected
                        @endif>Starter Business</option>
                      <option value="Registered Business" @if($ver->business_type=="Registered Business") selected
                        @endif>Registered Business</option>
                    </select>
                    <span class="text-xs text-gray">Starter Business can only accept up to
                      {{$currency->name.number_format($set->starter_limit)}} without business registration
                      documents.</span>
                  </div>
                </div>
                <div class="form-group row" id="otherFieldDiv">
                  ...
                  <div class="col-lg-10">
                    <input type="text" name="legal_name" class="form-control" @if($ver->status==1 ||
                    $user->business_level==3) disabled @endif value="{{$ver->legal_name}}" id="otherField">
                  </div>
                </div>
                <div class="form-group row" id="6xxotherFieldDiv">
                  <label class="col-form-label col-lg-2">{{__('Tax ID')}}</label>
                  <div class="col-lg-10">
                    <input type="text" name="tax_id" class="form-control" @if($ver->status==1 ||
                    $user->business_level==3) disabled @endif value="{{$ver->tax_id}}" id="6xxotherField">
                  </div>
                </div>
                <div class="form-group row" id="fFieldDiv">
                  <label class="col-form-label col-lg-2">{{__('BVN')}}</label>
                  <div class="col-lg-10">
                    <input type="text" name="vat_id" class="form-control" @if($ver->status==1 ||
                    $user->business_level==3) disabled @endif value="{{$ver->bvn}}" id="fField">
                  </div>
                </div>
                <div class="form-group row" id="ffFieldDiv">
                  <label class="col-form-label col-lg-2">{{__('Registration No')}}</label>
                  <div class="col-lg-10">
                    <input type="text" name="reg_no" class="form-control" @if($ver->status==1 ||
                    $user->business_level==3) disabled @endif value="{{$ver->reg_no}}" id="ffField">
                  </div>
                </div>
                <div class="form-group row" id="otherFieldDiv1">
                  <label class="col-form-label col-lg-2">{{__('Registration Type')}}</label>
                  <div class="col-lg-10">
                    <select class="form-control select" name="registration_type" @if($ver->status==1 ||
                      $user->business_level==3) disabled @endif id="otherField1">
                      <option value="government_instrumentality" @if($ver->
                        registration_type=="government_instrumentality") selected @endif>government instrumentality
                      </option>
                      <option value="governmental_unit" @if($ver->registration_type=="governmental_unit") selected
                        @endif>governmental unit</option>
                      <option value="incorporated_non_profit" @if($ver->registration_type=="incorporated_non_profit")
                        selected @endif>incorporated non profit</option>
                      <option value="limited_liability_partnership" @if($ver->
                        registration_type=="limited_liability_partnership") selected @endif>limited liability
                        partnership</option>
                      <option value="multi_member_llc" @if($ver->registration_type=="multi_member_llc") selected
                        @endif>multi member llc</option>
                      <option value="private_company" @if($ver->registration_type=="private_company") selected
                        @endif>private company</option>
                      <option value="private_corporation" @if($ver->registration_type=="private_corporation") selected
                        @endif>private corporation</option>
                      <option value="private_partnership" @if($ver->registration_type=="private_partnership") selected
                        @endif>private partnership</option>
                      <option value="public_company" @if($ver->registration_type=="public_company") selected
                        @endif>public company</option>
                      <option value="public_corporation" @if($ver->registration_type=="public_corporation") selected
                        @endif>public corporation</option>
                      <option value="public_partnership" @if($ver->registration_type=="public_partnership") selected
                        @endif>public partnership</option>
                      <option value="single_member_llc" @if($ver->registration_type=="single_member_llc") selected
                        @endif>single member llc</option>
                      <option value="sole_proprietorship" @if($ver->registration_type=="sole_proprietorship") selected
                        @endif>sole proprietorship</option>
                      <option value="tax_exempt_government_instrumentality" @if($ver->
                        registration_type=="tax_exempt_government_instrumentality") selected @endif>tax exempt
                        government instrumentality</option>
                      <option value="unincorporated_association" @if($ver->
                        registration_type=="unincorporated_association") selected @endif>unincorporated association
                      </option>
                      <option value="unincorporated_non_profit" @if($ver->
                        registration_type=="unincorporated_non_profit") selected @endif>unincorporated non profit
                      </option>
                    </select>
                  </div>
                </div>
                ...
                <div class="form-group row" id="otherFieldDiv2">
                  ...
                  <div class="col-lg-5">
                    <div class="custom-file">
                      <input type="file" class="custom-file-input" id="customFileLangx" @if($ver->status==1 ||
                      $user->business_level==3) disabled @endif name="proof" accept="image/*">
                      <label class="custom-file-label" for="customFileLangx">{{__('Front')}}</label>
                    </div>
                  </div>
                  <div class="col-lg-5">
                    <div class="custom-file">
                      <input type="file" class="custom-file-input sdsc" id="customFileLang4" @if($ver->status==1 ||
                      $user->business_level==3) disabled @endif name="proof_back" accept="image/*">
                      <label class="custom-file-label sdsc" for="customFileLang4">{{__('Back')}}</label>
                    </div>
                  </div>
                </div>
                @else
                <a href="{{url('/')}}/asset/profile/{{$ver->proof}}">{{__('View Proof of Registration
                  [Front]')}}</a><br>
                <a href="{{url('/')}}/asset/profile/{{$ver->proof_back}}">{{__('View Proof of Registration
                  [Back]')}}</a><br>
                @endif
                @if($ver->status==0 || $user->business_level==2)
                <div class="form-group row">
                  ...
                  <div class="col-lg-10">
                    <div class="custom-file">
                      <input type="file" class="custom-file-input sdsx" id="customFileLang2" @if($ver->status==1 ||
                      $user->business_level==3) disabled @endif name="paddress" accept="image/*" required>
                ...
                <div id="otherFieldDiv3">
                  <div class="form-group row">
                    ...
                    <div class="col-lg-10">
                      <div class="row">
                        <div class="col-6">
                          <input type="text" name="first_name" class="form-control" @if($ver->status==1 ||
                          $user->business_level==3) disabled @endif value="{{$ver->first_name}}" placeholder="First
                          Name" id="1otherField">
                        </div>
                        <div class="col-6">
                          <input type="text" name="last_name" class="form-control" @if($ver->status==1 ||
                          $user->business_level==3) disabled @endif value="{{$ver->last_name}}" placeholder="Last Name"
                          id="2otherField">
                        </div>
                      </div>
                    </div>
                  ...
                  <div class="form-group row">
                    ...
                    <div class="col-lg-10">
                      <div class="row">
                        <div class="col-4">
                          <select class="form-control select" name="b_month" @if($ver->status==1 ||
                            $user->business_level==3) disabled @endif id="3otherField">
                        ...
                        <div class="col-4">
                          <input type="number" name="b_day" class="form-control" @if($ver->status==1 ||
                          $user->business_level==3) disabled @endif placeholder="Day" value="{{$ver->day}}" min="1"
                          max="30" value="{{$user->last_name}}" id="4otherField">
                        </div>
                        <div class="col-4">
                          <input type="number" name="b_year" class="form-control" @if($ver->status==1 ||
                          $user->business_level==3) disabled @endif placeholder="Year" value="{{$ver->year}}" min="1950"
                          max="{{date('Y')}}" id="5otherField">
                        </div>
                      </div>
                    </div>
                  </div>
                  <div class="form-group row">
                    ...
                    <div class="col-lg-10">
                      <select class="form-control custom-select" name="nationality" @if($ver->status==1 ||
                        $user->business_level==3) disabled @endif id="country" id="7otherField">
                      </select>
                  ...
                  <div class="form-group row">
                    ...
                    <div class="col-lg-10">
                      <select class="form-control select" name="gender" @if($ver->status==1 || $user->business_level==3)
                        disabled @endif id="70otherField">
                  ...
                  <div class="form-group row">
                    ...
                    <div class="col-lg-10">
                      <select class="form-control select" name="id_type" @if($ver->status==1 ||
                        $user->business_level==3) disabled @endif id="7otherField">
                        <option value="National ID" @if($ver->id_type=="National ID") selected @endif>{{__('National
                          ID')}}</option>
                        <option value="International Passport" @if($ver->id_type=="International Passport") selected
                          @endif>{{__('International Passport')}}</option>
                        <option value="Voters Card" @if($ver->id_type=="Voters Card") selected @endif>{{__('Voters
                          Card')}}</option>
                        <option value="Driver License" @if($ver->id_type=="Driver License") selected @endif>{{__('Driver
                          License')}}</option>
                      </select>
                    </div>
                  </div>
                  ...
                  <div class="form-group row">
                    <div class="col-lg-12">
                      <div class="custom-file">
                        <input type="file" class="custom-file-input" @if($ver->status==1 || $user->business_level==3)
                        disabled @endif id="customFileLang1" name="idcard" accept="image/*">
                  ...
                  <div class="form-group row">
                    <div class="col-lg-12">
                      <div class="custom-file">
                        <input type="file" class="custom-file-input" @if($ver->status==1 || $user->business_level==3)
                        disabled @endif id="customFileLang3" name="idcard_back" accept="image/*">
                  ...
                  <a href="{{url('/')}}/asset/profile/{{$ver->idcard_back}}">{{__('View Identity Document
                    [Back]')}}</a><br>
                  @endif
                </div>
                <div class="text-center">
                  @if($ver->status==0 || $ver->status==3)
                  <button type="submit" class="btn btn-neutral btn-block">{{__('Submit Compliance For
                    Review')}}</button>
                  @elseif($ver->status==1)
                  <span class="badge badge-pill badge-primary"><i class="fad fa-check"></i> {{__('Under
                    Review')}}</span>
