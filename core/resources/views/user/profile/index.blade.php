    ...
    <div class="content-wrapper">
        <div class="row">
            <div class="col-md-12">
                    ...
                    <ul class="nav nav-pills nav-fill flex-column flex-md-row" id="tabs-icons-text" role="tablist">
                        <li class="nav-item">
                            <a class="nav-link mb-sm-3 mb-md-0 @if(route('user.profile')==url()->current()) active @endif"
                                ...
                                aria-controls="tabs-icons-text-1" aria-selected="true"><i class="fad fa-user"></i>
                                Profile</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link mb-sm-3 mb-md-0 @if(route('user.security')==url()->current()) active @endif"
                                ...
                                aria-controls="tabs-icons-text-2" aria-selected="fadse"><i class="fad fa-cogs"></i>
                                Security</a>
                        </li>
                        <li class="nav-item">
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="col-6">
                                                            <input type="text" name="phone" class="form-control"
                                                                required placeholder="Phone" value="{{$user->phone}}">
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-lg-9">
                                                    <div class="row">
                                                        ...
                                                        <div class="col-3">
                                                            <input type="text" name="hos_no" class="form-control"
                                                                required placeholder="NO" value="{{$user->hos_no}}">
                                                        </div>
                                                        <div class="col-9">
                                                        ...
                                                        <div class="col-4 mt-3">
                                                            <input type="text" name="state" class="form-control"
                                                                required placeholder="State" value="{{$user->state}}">
                                                        </div>
                                                        <div class="col-4 mt-3">
                                                            <input type="text" name="postal_code" class="form-control"
                                                                required placeholder="Postal Code" value="10001">
                                                        </div>
                                                        ...
                                                        <div class="col-lg-4 mt-3">
                                                            <select class="form-control select" disabled name="country"
                                                                ...
                                                                <option value="{{$val->country_id==$user->country}}"
                                                                    @if($val->country_id==$user->country) selected
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="col-md-6">
                                                            ...
                                                            <div class="form-group">
                                                                ...
                                                                <img src="https://i.ytimg.com/vi/SeriHm824hA/maxresdefault.jpg"
                                        ...
                                        document.getElementById('results').innerHTML = '<img src="'+data_uri+'"/>';
                                                        ...
                                                        <div class="col-12 mt-3">
                                                            <input type="number" name="bvn" class="form-control"
                                                                required placeholder="BVN" value="{{$user->bvn}}">
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-lg-9">
                                                <input type="text" name="business_name" class="form-control"
                                                    placeholder="Your Business Name" value="{{$user->business_name}}"
                                                    required>
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-lg-9">
                                                <div class="input-group">
                                                    ...
                                                    <input type="number" inputmode="numeric" name="phone" maxlength="14"
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            <form action="{{route('change.password')}}" method="post">
                                ...
                                <div class="form-group row">
                                    <div class="col-lg-12">
                                        <input type="password" name="new_password" id="new_password"
                                            class="form-control" placeholder="{{__('New password')}}" required>
                                ...
                                <p class="mb-2 text-default text-sm">{{__('Ensure that these requirements are met')}}
                                </p>
                                ...
                                <div class="text-right">
                                    <button type="submit" class="btn btn-neutral btn-sm">{{__('Change
                                        Password')}}</button>
                                </div>
                            </form>
                        </div>
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            <div class="align-item-sm-center flex-sm-nowrap text-left">
                                ...
                                <ul class="text-default text-sm">
                                    <li>{{__('Install an authentication app on your device. Any app that supports the
                                        Time-based One-Time
                                ...
                                <a data-toggle="modal" data-target="#modal-form2fa" href=""
                                ...
                                <div class="modal fade" id="modal-form2fa" tabindex="-1" role="dialog"
                                        ...
                                        <div class="modal-content">
                                            <div class="modal-body text-center">
                                                ...
                                                <form action="{{route('change.2fa')}}" method="post">
                                                    ...
                                                    <div class="form-group row">
                                                        <div class="col-lg-12">
                                                            <input type="text" pattern="\d*" name="code"
                                                                class="form-control" minlength="6" maxlength="6"
                                                                placeholder="Six digit code" required>
                ...
                <div class="tab-pane fade @if(route('user.api')==url()->current())show active @endif"
                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <p class="text-gray mb-1">Our documentation contains what you need to integrate
                                {{$set->site_name}} in your website.</p>
                            <a href="{{route('user.merchant-documentation')}}" class="btn btn-sm btn-neutral mb-5"><i
                                    class="fad fa-file-alt"></i> {{__('Go to Docs')}}</a>
                            <h4 class="mb-2 font-weight-bolder">{{__('Your Live Keys')}}</h4>
                            <div class="mb-3">
                                <span class="text-gray mb-3">You can use this key for Live Transaction
                            </div>
                            <div class="form-group row">
                                <div class="col-lg-12">
                                    <div class="input-group">
                                        <div class="input-group-prepend">
                                            <span class="input-group-text text-xs text-uppercase">{{__('key')}}</span>
                                        </div>
                                        <input type="text" name="public_key" class="form-control"
                                            placeholder="Public key" value="{{$key->key ?? " No Key"}}">
                                        <div class="input-group-prepend bg-gray">
                                            <span class="input-group-text btn-icon-clipboard"
                                                data-clipboard-text="{{$key->key ?? " No Key"}}" title="Copy"><i
                ...
                <div class="tab-pane fade @if(route('user.social')==url()->current())show active @endif"
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-lg-10">
                                        <input type="url" name="facebook" class="form-control"
                                            placeholder="Your Facebook Profile Link" value="{{$user->facebook}}">
                                    </div>
                                </div>
                                <div class="form-group row">
                                    ...
                                    <div class="col-lg-10">
                                        <input type="url" name="twitter" class="form-control"
                                            placeholder="Your Twitter Profile Link" value="{{$user->twitter}}">
                                    </div>
                                </div>
                                <div class="form-group row">
                                    ...
                                    <div class="col-lg-10">
                                        <input type="url" name="instagram" class="form-control"
                                            placeholder="Your Instagram Profile Link" value="{{$user->instagram}}">
                                    </div>
                                </div>
                                <div class="form-group row">
                                    ...
                                    <div class="col-lg-10">
                                        <input type="url" name="linkedin" class="form-control"
                                            placeholder="Your LinkedIn Profile Link" value="{{$user->linkedin}}">
                                    </div>
                                </div>
                                <div class="form-group row">
                                    ...
                                    <div class="col-lg-10">
                                        <input type="url" name="youtube" class="form-control"
                                            placeholder="Your Youtube Channel Link" value="{{$user->youtube}}">
                                    </div>
                                </div>
                                <div class="text-right">
                ...
                <div class="tab-pane fade @if(route('user.bank')==url()->current())show active @endif"
                            ...
                            <div class="modal-content">
                                ...
                                <div class="modal-body">
                                    <form role="form" action="{{route('submit.bank')}}" method="post">
                                        ...
                                        <div class="form-group row">
                                            <div class="col-lg-12">
                                                <input type="text" name="acct_no" pattern="\d*" maxlength="12"
                                                    placeholder="Account No" class="form-control" required>
                                            </div>
                                        </div>
                                        <div class="form-group row">
                                            <div class="col-lg-12">
                                        ...
                                        <div class="form-group">
                                            <div class="input-group">
                                                ...
                                                <input class="form-control"
                                                    placeholder="{{ __('Routing Number / Sort Code') }}" type="text"
                                                    name="routing_number" required>
                                            </div>
                                        </div>
                                        <div class="text-right">
                                            <button type="submit"
                                                class="btn btn-neutral btn-block">{{__('Save')}}</button>
                                        </div>
                                    </form>
                                </div>
                            </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <div class="card">
                                <div class="card-body">
                                        ...
                                        <div class="col-6 text-right">
                                            ...
                                            <div class="dropdown-menu dropdown-menu-left">
                                                ...
                                                <a class="dropdown-item"
                                                    href="{{route('bank.default', ['id' => $val->id])}}"><i
                                                        class="fad fa-check"></i>{{__('Default')}}</a>
                                                @endif
                                                <a class="dropdown-item" data-toggle="modal"
                                                    data-target="#modal-form{{$val->id}}" href="#"><i
                                    ...
                                    <div class="row">
                                        <div class="col">
                                            <p class="text-sm mb-0 font-weight-bolder text-uppercase">{{__('Default
                                                account')}}:
                                                @if($val->status==1) Yes @else No @endif</p>
                                            <p class="text-sm mb-0 font-weight-bolder text-uppercase">{{__('Account
                                                Name')}}:
                                                {{$val->acct_name}}</p>
                                            <p class="text-sm mb-0 font-weight-bolder text-uppercase">{{__('Routing
                                                No/Sort
                                                Code')}}:
                                                {{$val->routing_number}}</p>
                                            <p class="text-sm mb-2 font-weight-bolder text-uppercase">{{__('Account
                                                Type')}}:
                                                {{$val->account_type}}</p>
                                    ...
                                    <div class="modal-body p-0">
                                        <div class="card bg-white border-0 mb-0">
                                            <div class="card-header">
                                                ...
                                                <span class="mb-0 text-xs">{{__('Are you sure you want to delete this
                                                    bank
                                                    account?')}}</span>
                                            </div>
                                            <div class="card-body">
                                        ...
                                        <form role="form" action="{{route('bank.edit')}}" method="post">
                                            ...
                                            <div class="form-group row">
                                                <div class="col-lg-12">
                                                    <select class="form-control select" name="bank" required>
                                                        <option value="">{{__('Select Bank')}}</option>
                                                        @foreach($bnk as $xval)
                                                        <option value="{{$xval->id}}" @if($xval->id==$val->bank_id)
                                                            selected
                                                            @endif>{{$xval->name}}
                                                        </option>
                                                        @endforeach
                                            ...
                                            <div class="form-group row">
                                                <div class="col-lg-12">
                                                    <select class="form-control select" name="account_type" required>
                                                        <option value="">{{__('Account Type')}}</option>
                                                        <option value="individual" @if($val->account_type=='individual')
                                                            selected @endif>Individual
                                                        </option>
                                                        <option value="company" @if($val->account_type=='company')
                                                            selected
                                            ...
                                            <div class="form-group row">
                                                <div class="col-lg-12">
                                                    <input type="text" name="acct_name" placeholder="Account name"
                                            ...
                                            <div class="form-group">
                                                <div class="input-group">
                                                    ...
                                                    <input class="form-control"
                                                        placeholder="{{ __('Routing Number / Sort Code') }}" type="text"
                                                        name="routing_number" value="{{$val['routing_number']}}"
                                                        required>
                                                </div>
                                            </div>
                                            <div class="text-right">
                                                <button type="submit" class="btn btn-neutral btn-block">{{__('Update
                                                    Acount')}}</button>
                                            </div>
                                        </form>
                                    </div>
                        ...
                        <div class="col-md-12 mb-5">
                            <div class="text-center mt-8">
                                ...
                                <p class="text-dark text-sm card-text">We couldn't find any bank account to this account
                                </p>
                            </div>
                        </div>
                        @endif
                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-lg-10">
                                        <select class="form-control select" name="staff_size" @if($ver->status==1 ||
                                            ...
                                            <option value="1-5" @if($ver->staff_size=="1-5") selected @endif>1-5 people
                                            </option>
                                            <option value="5-50" @if($ver->staff_size=="5-50") selected @endif>5-50
                                                people
                                            </option>
                                            <option value="50+" @if($ver->staff_size=="50+") selected @endif>50+ people
                                            </option>
                                        </select>
                                    </div>
                                </div>
                                <div class="form-group row">
                                    ...
                                    <div class="col-lg-10">
                                        <select class="form-control select" name="industry" @if($ver->status==1 ||
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-lg-10">
                                        <select class="form-control select" name="category" @if($ver->status==1 ||
                                            $user->business_level==3)
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-lg-10">
                                        <select class="form-control select" name="business_type" @if($ver->status==1 ||
                                            ...
                                            <option value="Starter Business" @if($ver->business_type=="Starter
                                                Business")
                                                selected
                                                @endif>Starter Business</option>
                                            <option value="Registered Business" @if($ver->business_type=="Registered
                                                Business") selected
                                                @endif>Registered Business</option>
                                        </select>
                                        <span class="text-xs text-gray">Starter Business can only accept up to
                                            {{$currency->name.number_format($set->starter_limit)}} without business
                                            registration
                                            documents.</span>
                                    </div>
                                </div>
                                <div class="form-group row" id="otherFieldDiv">
                                    ...
                                    <div class="col-lg-10">
                                        ...
                                        $user->business_level==3) disabled @endif value="{{$ver->legal_name}}"
                                        id="otherField">
                                    </div>
                                </div>
                                <div class="form-group row" id="6xxotherFieldDiv">
                                    ...
                                    <div class="col-lg-10">
                                        ...
                                        $user->business_level==3) disabled @endif value="{{$ver->tax_id}}"
                                        id="6xxotherField">
                                    </div>
                                </div>
                                    ...
                                    <div class="col-lg-10">
                                        <select class="form-control select" name="registration_type" @if($ver->status==1
                                            ...
                                            <option value="government_instrumentality" @if($ver->
                                                registration_type=="government_instrumentality") selected
                                                @endif>government
                                                instrumentality
                                            </option>
                                            <option value="governmental_unit" @if($ver->
                                                registration_type=="governmental_unit") selected
                                                @endif>governmental unit</option>
                                            <option value="incorporated_non_profit" @if($ver->
                                                registration_type=="incorporated_non_profit")
                                                selected @endif>incorporated non profit</option>
                                            <option value="limited_liability_partnership" @if($ver->
                                                registration_type=="limited_liability_partnership") selected
                                                @endif>limited
                                                liability
                                                partnership</option>
                                            <option value="multi_member_llc" @if($ver->
                                                registration_type=="multi_member_llc") selected
                                                @endif>multi member llc</option>
                                            <option value="private_company" @if($ver->
                                                registration_type=="private_company")
                                                selected
                                                @endif>private company</option>
                                            <option value="private_corporation" @if($ver->
                                                registration_type=="private_corporation") selected
                                                @endif>private corporation</option>
                                            <option value="private_partnership" @if($ver->
                                                registration_type=="private_partnership") selected
                                                @endif>private partnership</option>
                                            <option value="public_company" @if($ver->
                                                registration_type=="public_company")
                                                selected
                                                @endif>public company</option>
                                            <option value="public_corporation" @if($ver->
                                                registration_type=="public_corporation") selected
                                                @endif>public corporation</option>
                                            <option value="public_partnership" @if($ver->
                                                registration_type=="public_partnership") selected
                                                @endif>public partnership</option>
                                            <option value="single_member_llc" @if($ver->
                                                registration_type=="single_member_llc") selected
                                                @endif>single member llc</option>
                                            <option value="sole_proprietorship" @if($ver->
                                                registration_type=="sole_proprietorship") selected
                                                @endif>sole proprietorship</option>
                                            <option value="tax_exempt_government_instrumentality" @if($ver->
                                                registration_type=="tax_exempt_government_instrumentality") selected
                                                @endif>tax exempt
                                                government instrumentality</option>
                                            <option value="unincorporated_association" @if($ver->
                                                registration_type=="unincorporated_association") selected
                                                @endif>unincorporated association
                                            </option>
                                            <option value="unincorporated_non_profit" @if($ver->
                                                registration_type=="unincorporated_non_profit") selected
                                                @endif>unincorporated non profit
                                            </option>
                                        </select>
                                    </div>
                                </div>
                                ...
                                <div class="form-group row" id="otherFieldDiv2">
                                    ...
                                    <div class="col-lg-5">
                                        <div class="custom-file">
                                            <input type="file" class="custom-file-input" id="customFileLangx"
                                                @if($ver->status==1 ||
                                            $user->business_level==3) disabled @endif name="proof" accept="image/*">
                                            <label class="custom-file-label"
                                                for="customFileLangx">{{__('Front')}}</label>
                                        </div>
                                    </div>
                                    <div class="col-lg-5">
                                        <div class="custom-file">
                                            <input type="file" class="custom-file-input sdsc" id="customFileLang4"
                                                @if($ver->status==1 ||
                                            $user->business_level==3) disabled @endif name="proof_back"
                                            accept="image/*">
                                            <label class="custom-file-label sdsc"
                                                for="customFileLang4">{{__('Back')}}</label>
                                        </div>
                                    </div>
                                </div>
                                @else
                                <a href="{{url('/')}}/asset/profile/{{$ver->proof}}">{{__('View Proof of Registration
                                    [Front]')}}</a><br>
                                <a href="{{url('/')}}/asset/profile/{{$ver->proof_back}}">{{__('View Proof of
                                    Registration
                                    [Back]')}}</a><br>
                                @endif
                                @if($ver->status==0 || $user->business_level==2)
                                <div class="form-group row">
                                    <label class="col-form-label col-lg-2">{{__('Utility Bill')}}</label>
                                    <div class="col-lg-10">
                                        <div class="custom-file">
                                            <input type="file" class="custom-file-input sdsx" id="customFileLang2"
                                                @if($ver->status==1 ||
                                            $user->business_level==3) disabled @endif name="paddress" accept="image/*"
                                            required>
                                            <label class="custom-file-label sdsx" for="customFileLang2">{{__('Select
                                                document')}}</label>
                                        </div>
                                    </div>
                                </div>
                                @else
                                <a href="{{url('/')}}/asset/profile/{{$ver->paddress}}">{{__('View Proof of
                                    Address')}}</a><br>
                                @endif
                                <div id="otherFieldDiv3">
                                        ...
                                        <div class="col-lg-10">
                                            <div class="row">
                                                <div class="col-6">
                                                    <input type="text" name="first_name" class="form-control"
                                                        @if($ver->status==1 ||
                                                    $user->business_level==3) disabled @endif
                                                    value="{{$ver->first_name}}"
                                                    placeholder="First
                                                    Name" id="1otherField">
                                                </div>
                                                <div class="col-6">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-lg-10">
                                            <div class="row">
                                                <div class="col-4">
                                                    <select class="form-control select" name="b_month"
                                                        @if($ver->status==1
                                                        ||
                                                        $user->business_level==3) disabled @endif id="3otherField">
                                                        <option value="1" @if($ver->month=="1") selected @endif>Jan
                                                        </option>
                                                        <option value="2" @if($ver->month=="2") selected @endif>Feb
                                                        </option>
                                                        <option value="3" @if($ver->month=="3") selected @endif>Mar
                                                        </option>
                                                        <option value="4" @if($ver->month=="4") selected @endif>Apr
                                                        </option>
                                                        <option value="5" @if($ver->month=="5") selected @endif>May
                                                        </option>
                                                        <option value="6" @if($ver->month=="6") selected @endif>Jun
                                                        </option>
                                                        <option value="7" @if($ver->month=="7") selected @endif>Jul
                                                        </option>
                                                        <option value="8" @if($ver->month=="8") selected @endif>Aug
                                                        </option>
                                                        <option value="9" @if($ver->month=="9") selected @endif>Sep
                                                        </option>
                                                        <option value="10" @if($ver->month=="10") selected @endif>Oct
                                                        </option>
                                                        <option value="11" @if($ver->month=="11") selected @endif>Nov
                                                        </option>
                                                        <option value="12" @if($ver->month=="12") selected @endif>Dec
                                                        </option>
                                                    </select>
                                                </div>
                                                <div class="col-4">
                                                    <input type="number" name="b_day" class="form-control"
                                                        @if($ver->status==1
                                                    ||
                                                    $user->business_level==3) disabled @endif placeholder="Day"
                                                    value="{{$ver->day}}" min="1"
                                                ...
                                                <div class="col-4">
                                                    <input type="number" name="b_year" class="form-control"
                                                        @if($ver->status==1
                                                    ||
                                                    $user->business_level==3) disabled @endif placeholder="Year"
                                                    value="{{$ver->year}}" min="1950"
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-lg-10">
                                            ...
                                            <span class="text-xs text-gray">Current Nationality:
                                                {{$ver->nationality}}</span>
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        <label class="col-form-label col-lg-2">{{__('Gender')}}</label>
                                        <div class="col-lg-10">
                                            <select class="form-control select" name="gender" @if($ver->status==1 ||
                                                $user->business_level==3)
                                                disabled @endif id="70otherField">
                                                <option value="male" @if($ver->gender=="male") selected
                                                    @endif>{{__('Male')}}</option>
                                                <option value="female" @if($ver->gender=="female") selected
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-lg-10">
                                            <select class="form-control select" name="id_type" @if($ver->status==1 ||
                                                ...
                                                <option value="National ID" @if($ver->id_type=="National ID") selected
                                                    @endif>{{__('National
                                                    ID')}}</option>
                                                <option value="International Passport" @if($ver->id_type=="International
                                                    Passport") selected
                                                    @endif>{{__('International Passport')}}</option>
                                                <option value="Voters Card" @if($ver->id_type=="Voters Card") selected
                                                    @endif>{{__('Voters
                                                    Card')}}</option>
                                                <option value="Driver License" @if($ver->id_type=="Driver License")
                                                    selected
                                                    @endif>{{__('Driver
                                                    License')}}</option>
                                            </select>
                                    ...
                                    <div class="form-group row">
                                        <div class="col-lg-12">
                                            <div class="custom-file">
                                                <input type="file" class="custom-file-input" @if($ver->status==1 ||
                                                $user->business_level==3)
                                                disabled @endif id="customFileLang3" name="idcard_back"
                                                accept="image/*">
                                                <label class="custom-file-label tests"
                                                    for="customFileLang3">{{__('Back')}}</label>
                                            </div>
                                        </div>
                                    </div>
                                    @else
                                    <a href="{{url('/')}}/asset/profile/{{$ver->idcard}}">{{__('View Identity Document
                                        [Front]')}}</a><br>
                                    <a href="{{url('/')}}/asset/profile/{{$ver->idcard_back}}">{{__('View Identity
                                        Document
                                        [Back]')}}</a><br>
                                    @endif
                                </div>
                                <div class="text-center">
                                    ...
                                    <button type="submit" class="btn btn-neutral btn-block">{{__('Submit Compliance For
                                        Review')}}</button>
                                    @elseif($ver->status==1)
                                    <span class="badge badge-pill badge-primary"><i class="fad fa-check"></i>
                                        {{__('Under
                                        Review')}}</span>
                                    @elseif($ver->status==2 && $user->business_level==2)
                                    <button type="submit" class="btn btn-neutral btn-block mb-5">{{__('Update
                                        Compliance')}}</button>
                                    <span class="badge badge-pill badge-success"><i class="fad fa-check"></i>
                                        {{__('Approved')}}</span>
