              ...
              <form action="{{route('submit.compliance')}}" method="post" enctype="multipart/form-data">
                <div class="">
                  <div class="">
                      ...
                      <div class="form-group row">
                        <label class="col-form-label col-lg-2">{{__('Tell us about your company')}}</label>
                        <div class="col-lg-10">
                      ...
                      <div class="form-group row" id="6xxotherFieldDiv">
                          <label class="col-form-label col-lg-2">{{__('Tax ID or TIN NO')}}</label>
                          <div class="col-lg-10">
                      ...
                      <div class="form-group row" id="fFieldDiv">
                          ...
                          <div class="col-lg-10">
                              <input type="text" name="vat_id" class="form-control" @if($ver->status==1 || $user->business_level==3) disabled @endif value="{{$ver->bvn}}"  id="fField">
                          </div>
                      </div>
                      ...
                      <div class="form-group row" id="otherFieldDiv2">
                        <label class="col-form-label col-lg-2">{{__('Company Registration Document')}}</label>
                        <div class="col-lg-5">
                      ...
                      @if($ver->status==0 || $user->business_level==2)
                      <div class="form-group row">
                        <label class="col-form-label col-lg-2">{{__('Proof of Address (ex: PHCN Bill, Phone Bill, Waste Bill')}}</label>
                        <div class="col-lg-10">
                          <div class="custom-file">
